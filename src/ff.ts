    ...
    suggestions: [
      {
        ...
        description: "Ff sync",
        insertValue: `\b\b\bcd ~/repos/portal-meta\nmeta git checkout master\nmeta git pull\nff artisan migrate && ff artisan migrate --velocity && ff npm ci && ff npm -- run buildDev\n`,
      },
      {
        icon: "🟢",
      ...
      },
      {
        ...
        name: "github/portal",
        insertValue:
          "\b\b\bopen https://github.com/FreedomForeverSolar/portal\n",
      ...
      },
      {
        ...
        insertValue:
          "\b\b\bopen https://github.com/FreedomForeverSolar/shared-resources\n",
      ...
      },
      {
        ...
        insertValue:
          "\b\b\bopen https://github.com/FreedomForeverSolar/field-app\n",
      ...
      },
      {
        ...
        insertValue:
          "\b\b\bopen https://github.com/FreedomForeverSolar/sales-app\n",
      ...
      },
      {
        ...
        insertValue:
          "\b\b\bopen https://github.com/FreedomForeverSolar/velocity\n",
      ...
      },
      {
        ...
        name: "meta git pull",
        insertValue:
          "\b\b\bcd ~/repos/portal-meta\nmeta git checkout master\nmeta git pull\n",
        description:
          "Checks out master and pulls all repos inside of the portal-meta directory",
      },
    ],
  },
  subcommands: [
      ...
      args: {
        ...
        suggestions: [
          ...
          },
          {
            ...
            displayName: "hot",
            description:
              "Hot Reload Enabled: Compiles the JS and recompiles if changes",
          },
          {
            name: "-- run watchDev",
            priority: 90,
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          name: ["--date", "-d"],
          description:
            "Sets which export date to use. Must be in format YYYY-MM-DD Ex. 1970-01-20",
        },
      ],
    },
    {
      ...
      description:
        "Removes required files for laravel upgrade and runs composer install",
      options: [
        {
          name: ["--help", "-h"],
          description: "Show help for ff ssh",
