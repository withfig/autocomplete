const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    ...
    },
    {
      ...
      description: "Get detail data for the Proton pipeline service role",
      options: [
        {
          name: "--cli-input-json",
          description:
    ...
    {
      name: "get-repository",
      description: "Get detail data for a repository",
      options: [
        {
          name: "--name",
          description: "The repository name, for example myrepos/myrepo",
    ...
    },
    {
      ...
      description: "List repositories with detail data",
      options: [
        {
          name: "--max-results",
