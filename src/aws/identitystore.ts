const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    ...
    {
      name: "create-user",
      description: "Creates a new user within the specified identity store",
      options: [
        {
          name: "--identity-store-id",
          description: "The globally unique identifier for the identity store",
    ...
    },
    {
      ...
      description: "Retrieves the MembershipId in a group",
      options: [
        {
          name: "--identity-store-id",
          description: "The globally unique identifier for the identity store",
    ...
    },
    {
      ...
      description: "Returns if a member exists in specified groups",
      options: [
        {
          name: "--identity-store-id",
          description: "The globally unique identifier for the identity store",
