const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    ...
    },
    {
      ...
      description: "A list of the pricing plans associated with a pricing rule",
      options: [
        {
          name: "--billing-period",
          description:
    ...
    },
    {
      ...
      description: "Lists the pricing rules associated with a pricing plan",
      options: [
        {
          name: "--billing-period",
          description:
    ...
    },
    {
      ...
      description: "List the resources associated to a custom line item",
      options: [
        {
          name: "--billing-period",
          description:
