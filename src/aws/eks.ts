const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    ...
    },
    {
      name: "create-addon",
      description:
        "Creates an Amazon EKS add-on. Amazon EKS add-owns help to automate the provisioning and lifecycle management of common operational software for Amazon EKS clusters. Amazon EKS add-owns require clusters running version 1.18 or later because Amazon EKS add-owns rely on the Server-side Apply Kubernetes feature, which is only available in Kubernetes 1.18 and later. For more information, see Amazon EKS add-owns in the Amazon EKS User Guide",
      options: [
        {
          name: "--cluster-name",
    ...
    {
      name: "list-addons",
      description: "Lists the available add-owns",
      options: [
        {
          name: "--cluster-name",
          description: "The name of the cluster",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          name: "--addon-name",
          description:
            "The names of the installed add-owns that have available updates",
          args: {
            name: "string",
          },
        },
