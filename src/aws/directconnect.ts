    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          description:
            "Indicates whether you want the connection to support MAC Security (MACsec). MAC Security (MACsec) is only available on dedicated connections. For information about MAC Security (MACsec) prerequisite, see MACsec prerequisite in the Direct Connect User Guide",
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          name: "--request-mac-sec",
          description:
            "Indicates whether the connection will support MAC Security (MACsec).  All connections in the LAG must be capable of supporting MAC Security (MACsec). For information about MAC Security (MACsec) prerequisite, see MACsec prerequisite in the Direct Connect User Guide",
        },
        {
          name: "--no-request-mac-sec",
          description:
