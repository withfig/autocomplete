    ...
    },
    {
      ...
      subcommands: [
        ...
        },
        {
          ...
          description:
            "Wait until a StreamingSessionDeleted. Use this after invoking Deletesession It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 180 failed checks",
          options: [
            {
              name: "--session-id",
              description: "The streaming session ID",
