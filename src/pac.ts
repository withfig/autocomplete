...
const appTemplatesLocations: Fig.Suggestion[] = [
...
const azureLocations: Fig.Suggestion[] = [
  { name: "asia", description: "asia" },
  { name: "asiapacific", description: "asiapacific" },
  { name: "australia", description: "australia" },
  { name: "australiacentral", description: "australiacentral" },
  { name: "australiacentral2", description: "australiacentral2" },
  { name: "australiaeast", description: "australiaeast" },
  { name: "australiasoutheast", description: "australiasoutheast" },
  { name: "brazil", description: "brazil" },
  { name: "brazilsouth", description: "brazilsouth" },
  { name: "brazilsoutheast", description: "brazilsoutheast" },
  { name: "brazilus", description: "brazilus" },
  { name: "canada", description: "canada" },
  { name: "canadacentral", description: "canadacentral" },
  { name: "canadaeast", description: "canadaeast" },
  { name: "centralindia", description: "centralindia" },
  { name: "centralus", description: "centralus" },
  { name: "centraluseuap", description: "centraluseuap" },
  { name: "centralusstage", description: "centralusstage" },
  { name: "eastasia", description: "eastasia" },
  { name: "eastasiastage", description: "eastasiastage" },
  { name: "eastus", description: "eastus" },
  { name: "eastus2", description: "eastus2" },
  { name: "eastus2euap", description: "eastus2euap" },
  { name: "eastus2stage", description: "eastus2stage" },
  { name: "eastusstage", description: "eastusstage" },
  { name: "eastusstg", description: "eastusstg" },
  { name: "europe", description: "europe" },
  { name: "france", description: "france" },
  { name: "francecentral", description: "francecentral" },
  { name: "francesouth", description: "francesouth" },
  { name: "germany", description: "germany" },
  { name: "germanynorth", description: "germanynorth" },
  { name: "germanywestcentral", description: "germanywestcentral" },
  { name: "global", description: "global" },
  { name: "india", description: "india" },
  { name: "israelcentral", description: "israelcentral" },
  { name: "italynorth", description: "italynorth" },
  { name: "japan", description: "japan" },
  { name: "japaneast", description: "japaneast" },
  { name: "japanwest", description: "japanwest" },
  { name: "jioindiacentral", description: "jioindiacentral" },
  { name: "jioindiawest", description: "jioindiawest" },
  { name: "korea", description: "korea" },
  { name: "koreacentral", description: "koreacentral" },
  { name: "koreasouth", description: "koreasouth" },
  { name: "northcentralus", description: "northcentralus" },
  { name: "northcentralusstage", description: "northcentralusstage" },
  { name: "northeurope", description: "northeurope" },
  { name: "norway", description: "norway" },
  { name: "norwayeast", description: "norwayeast" },
  { name: "norwaywest", description: "norwaywest" },
  { name: "polandcentral", description: "polandcentral" },
  { name: "qatarcentral", description: "qatarcentral" },
  { name: "singapore", description: "singapore" },
  { name: "southafrica", description: "southafrica" },
  { name: "southafricanorth", description: "southafricanorth" },
  { name: "southafricawest", description: "southafricawest" },
  { name: "southcentralus", description: "southcentralus" },
  { name: "southcentralusstage", description: "southcentralusstage" },
  { name: "southcentralusstg", description: "southcentralusstg" },
  { name: "southeastasia", description: "southeastasia" },
  { name: "southeastasiastage", description: "southeastasiastage" },
  { name: "southindia", description: "southindia" },
  { name: "swedencentral", description: "swedencentral" },
  { name: "switzerland", description: "switzerland" },
  { name: "switzerlandnorth", description: "switzerlandnorth" },
  { name: "switzerlandwest", description: "switzerlandwest" },
  { name: "uae", description: "uae" },
  { name: "uaecentral", description: "uaecentral" },
  { name: "uaenorth", description: "uaenorth" },
  { name: "uk", description: "uk" },
  { name: "uksouth", description: "uksouth" },
  { name: "ukwest", description: "ukwest" },
  { name: "unitedstates", description: "unitedstates" },
  { name: "unitedstateseuap", description: "unitedstateseuap" },
  { name: "westcentralus", description: "westcentralus" },
  { name: "westeurope", description: "westeurope" },
  { name: "westindia", description: "westindia" },
  { name: "westus", description: "westus" },
  { name: "westus2", description: "westus2" },
  { name: "westus2stage", description: "westus2stage" },
  { name: "westus3", description: "westus3" },
  { name: "westusstage", description: "westusstage" },
];
          ...
          options: [
            {
              ...
              args: {
                name: "string",
                suggestions: appTemplatesLocations,
              },
            },
          ],
        },
