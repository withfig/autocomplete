    ...
    return {
      ...
      subcommands: [
        ...
        },
        {
          name: "alias",
          description:
            "Manage aliases that allow fin @alias execution (fin help alias)",
          subcommands: [
            {
              name: "list",
            ...
            },
            {
              name: "",
              description:
                "Create/update alias with <alias_name> that links to <path>",
        ...
        },
        {
          name: "hosts",
          description:
            "Hosts file commands: add, remove, list (fin help hosts)",
          subcommands: [
            {
              name: "add",
              description:
        ...
        },
        {
          ...
          name: "pull",
          description:
            "Commands for interacting with Hosting Providers (fin help pull)",
        },
        {
          name: ["run-cli", "rc"],
          description:
