      ...
      options: [
        {
          name: ["--path", "-p"],
          description:
            "The path to the directory that contains the workspace or project whose dependencies will be fetched. The default is the current directory",
        },
      ],
      subcommands: [
        {
          ...
          options: [
            {
              name: ["--path", "-p"],
              description:
                "The path to the directory that contains the workspace or project whose dependencies will be updated. The default is the current directory",
            },
          ],
        },
      ],
