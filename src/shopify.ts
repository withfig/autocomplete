        ...
        helpOption,
        {
          ...
          options: [
            ...
            },
            {
              name: "--language",
              description:
                "He format or language of the script. Valid values: wasm. If unspecified, then your script project is created in WebAssembly (Wasm), which is the default format for script projects",
              args: {
