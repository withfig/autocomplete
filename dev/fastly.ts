...
export const completionSpec: Fig.Spec = {
  ...
  subcommands: [
          ...
          options: [
            {
              name: "--service-id",
              description:
                "Existing service ID to use. By default, this command creates a new service",
              args: [
                {
                  name: "service-id",
                  isOptional: true,
    ...
    },
    {
      name: "stats",
      description:
        "View statistics (historical and realtime) for a Fastly service",
      subcommands: [
        {
          name: "regions",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              name: "--from",
              description:
                "From time, accepted formats at https://docs.fastly.com/api/stats#Range",
              args: [
                {
                  name: "from",
                  isOptional: true,
