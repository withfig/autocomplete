...
const ghUpgradeOptions: Record<string, Fig.Option> = {
  help: { name: "--help", description: "Show help for command" },
  all: { name: "--all", description: "Upgrade all extensions" },
  force: { name: "--force", description: "Force upgrade extensions" },
};
    ...
    },
    {
      ...
      subcommands: [
        ...
        },
        {
          name: "upgrade",
          description: "Remove an installed extension",
          options: [ghOptions.ghUpgradeOptions],
          args: {
            name: "name",
          },
        },
