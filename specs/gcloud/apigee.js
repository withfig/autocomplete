            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--oauth-scopes",
                            description: "Comma-separated list of OAuth scopes that are validated at runtime. Apigee validates that the scopes in any access token presented match the scopes defined in the OAuth policy assoicated with the API product.",
                            args: {
                                name: "SCOPE",
                                description: "list",
                                suggestions: [],
