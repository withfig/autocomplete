...
var extensionManagementOptions = [
    {
        name: "--extensions-dir",
...
var completionSpec = {
    ...
    options: __spreadArray(__spreadArray(__spreadArray([], commonOptions), extensionManagementOptions), troubleshootingOptions),
};
