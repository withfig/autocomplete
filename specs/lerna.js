...
var getAllScriptsFromPackages = {
    ...
    postProcess: function (output) {
        ...
        var packages = output.split(SPLIT_CHAR).filter(function (e) { return e.trim() !== ""; });
        var scripts = [];
...
var packageScopes = ["public", "restricted"];
var npmClientOption = {
    name: "--npm-client",
...
var globalOptions = [
    ...
    },
    {
        ...
        args: {
            name: "loglevel",
            suggestions: LOG_LEVELS.map(function (level) { return ({
                name: level,
                icon: "fig://icon?type=string",
            }); }),
        },
...
var completionSpec = {
    ...
    subcommands: [
        ...
        /** Bootstrap Subcommand */
        {
            ...
            options: __spreadArray(__spreadArray([], filterOptions), [
                npmClientOption,
                {
                    name: "--hoist",
        ...
        __assign(__assign({}, listSubCommand), { name: "ls" }),
        __assign(__assign({}, listSubCommand), { name: "ll" }),
        __assign(__assign({}, listSubCommand), { name: "la" }),
        __assign(__assign({}, listSubCommand), { name: "list" }),
        /** Changed Subcommand */
        {
            name: "changed",
        ...
        /** Run Subcommand */
        {
            ...
            options: __spreadArray(__spreadArray(__spreadArray([], globalOptions), filterOptions), runOptions),
            args: {
                name: "script",
        ...
        /** Version Subcommand */
        {
            ...
            options: [
                ...
                {
                    name: "--create-release",
                    description: "Create an official release based on the changes pacakges.",
                    args: {
                        name: "type",
                        suggestions: [
                            {
                ...
                },
                {
                    ...
                    args: {
                        ...
                        generators: {
                            script: "git remote",
                            postProcess: function (output) {
                                return output.split("\n").map(function (remoteName) { return ({
                                    name: remoteName,
                                    description: "remote",
        ...
        /** Add Subcommand */
        {
            ...
            options: __spreadArray(__spreadArray(__spreadArray([], globalOptions), filterOptions), [
                {
                    name: "--dev",
            ...
            options: [
                {
                    ...
                    args: {
                        name: "scope",
                        suggestions: packageScopes.map(function (scope) { return ({
                            name: scope,
                            icon: "fig://icon?type=string",
                        }); }),
                    },
