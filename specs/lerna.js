...
var getAllScriptsFromPackages = {
  ...
  postProcess: function (output) {
    ...
    return Array.from(new Set(scripts)).map(function (scriptName) {
      return {
        name: scriptName,
...
var globalOptions = [
  ...
  },
  {
    ...
    args: {
      name: "loglevel",
      suggestions: LOG_LEVELS.map(function (level) {
        return {
          name: level,
          icon: "fig://icon?type=string",
        };
  ...
  subcommands: [
    ...
    /** Run Subcommand */
    {
      ...
      options: __spreadArray(
        __spreadArray(__spreadArray([], globalOptions), filterOptions),
        runOptions
      ),
      args: {
        name: "script",
    ...
    /** Version Subcommand */
    {
      ...
      args: {
        name: "version",
        isOptional: true,
        suggestions: SEMVER_NOUNS.map(function (versionName) {
          return {
            name: versionName,
            icon: "fig://icon?type=npm",
          };
      ...
      options: [
        {
          ...
          args: {
            name: "scope",
            suggestions: packageScopes.map(function (scope) {
              return {
                name: scope,
                icon: "fig://icon?type=string",
              };
