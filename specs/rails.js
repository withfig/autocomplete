    ...
    args: [
      {
        ...
        generators: {
          ...
          postProcess: function (out) {
            ...
            var dict = __spreadArray(["Rails:"], lines).reduce(function (
              arr,
              line
            ) {
              if (line.endsWith(":"))
    ...
    generateSpec: function (_, executeShellCommand) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, executeShellCommand("rails test --help")];
            case 1:
              helpText = _a.sent();
              argRegex = /(?:(-[a-zA-Z]), )?(--[^ ]+?)[ =]([A-Z_]+)?[ \r\n]+([^\n]+)/g;
              options = Array.from(helpText.matchAll(argRegex)).map(function (
                match
              ) {
                var _match = match[0],
                  _short = match[1],
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            helpText = _a.sent();
            defaultCommandNames = defaultCommands.map(function (c) {
              return c.name;
            });
            ...
            commands = matches
              ...
              .filter(function (cmd) {
                return !defaultCommandNames.includes(cmd.name);
              });
            return [
              2 /*return*/,
              {
