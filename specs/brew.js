    ...
    subcommands: [
        ...
        { name: "config", description: "Show Homebrew and system configuration info" },
        {
            ...
            args: {
                ...
                generators: {
                    script: "homebrew_path=$(brew --repository); ls -1 $homebrew_path/Library/Taps/homebrew/homebrew-core/Formula $homebrew_path/Library/Taps/homebrew/homebrew-cask/Casks",
                    postProcess: function (out) {
