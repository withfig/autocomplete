...
var gitGenerators = {
    ...
    // Files for staging
    files_for_staging: {
        custom: function (context, runFigCommand) { return __awaiter(void 0, void 0, void 0, function () {
            var out, items;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, runFigCommand("git status --short")];
                    case 1:
                        out = _a.sent();
                        if (out.startsWith("fatal:")) {
                            return [2 /*return*/, []];
                        ...
                        return [2 /*return*/, items.map(function (item) {
                                ...
                                return {
                                    ...
                                    priority: context.some(function (ctx) { return ctx.includes(file); }) ? 50 : 100,
                                };
                            })];
                }
            });
