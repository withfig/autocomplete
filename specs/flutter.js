    ...
    postProcess: function (out) {
      return out
        ...
        .map(function (deviceInfo) {
          return deviceInfo.map(function (info) {
            return info.trim();
          });
        })
        .map(function (device) {
        ...
        __spreadArray(
          __spreadArray(
            __spreadArray(
              __spreadArray(
                __spreadArray(
                  __spreadArray(__spreadArray([], globalOpts), currentPackage),
                  [
                    {
                      name: "--watch",
                      description:
    ...
    },
    {
      ...
      options: __spreadArray(
        __spreadArray(
          __spreadArray(
            __spreadArray(
              __spreadArray(__spreadArray([], globalOpts), [
                debug,
                profile,
                target,
                observatoryPort,
    ...
    },
    {
      ...
      options: __spreadArray(
        __spreadArray(
          __spreadArray(
            __spreadArray(
              __spreadArray(__spreadArray([], globalOpts), pub),
              offline
            ),
            withDriverTest
          ),
            ...
            __spreadArray(
              __spreadArray(
                __spreadArray(
                  __spreadArray(
                    __spreadArray(
                      __spreadArray(__spreadArray([], globalOpts), run),
                      keepAppRunning
                    ),
                    [
                      {
