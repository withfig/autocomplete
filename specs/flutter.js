        ...
        filterTemplateSuggestions: function (suggestions) {
            return suggestions.filter(function (suggestion) {
                return suggestion.type === 'folder' ||
                    (typeof suggestion.name === 'string' && suggestion.name.endsWith('.dart'));
            });
        },
    },
};
...
var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            options: __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], globalOpts), [
                debug,
                profile,
                target,
                observatoryPort,
        ...
        },
        {
            ...
            options: __spreadArray(__spreadArray([], globalOpts), overwrite),
        },
        {
            name: 'build',
            ...
            args: {
                ...
                generators: {
                    ...
                    postProcess: function (out) {
                        return out
                            .split('\n')
                            .filter(function (channel) { return channel.match(/\w+$/); })
        ...
        },
        {
            ...
            options: __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], globalOpts), analytics), [
                {
            ...
            ]), enableWeb), enableLinuxDesktop), enableMacosDekstop), enableWidowsDesktop), singleWidgetReloadOptimization), enableAndroid), enableIos), enabledFuchsia), experimentalInvalidationStrategy), [
                {
                    name: '--clear-features',
        ...
        },
        {
            ...
            options: __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], globalOpts), pub), offline), withDriverTest), overwrite), [
                {
                    name: '--description',
        ...
        },
        {
            ...
            options: __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], globalOpts), run), keepAppRunning), [
                {
        ...
        },
        {
            ...
            options: __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], globalOpts), [
                {
                    name: '--arb-dir',
        ...
        },
        {
            ...
            options: __spreadArray(__spreadArray([], globalOpts), [deviceUser, deviceTimeout]),
        },
        {
            name: 'logs',
        ...
        },
        {
            ...
            options: __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], globalOpts), run), [
                {
            ...
            ]), awaitFirstFrameWhenTracing), useTestFonts), build), [
                {
                    name: '--pid-file',
                    description: 'Specify a file to write the process id to. You can send SIGUSR1 to trigger a hot reload and SIGUSR2 to trigger a hot restart.',
                }
        ...
        },
        {
            ...
            options: __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], globalOpts), pub), nullAssertions), trackWidgetCreation), [
                dartDefine,
                {
                    name: '--web-renderer',
                    description: 'The renderer implementation to use when building for the web. Possible values are: html - always use the HTML renderer. This renderer uses a combination of HTML, CSS, SVG, 2D Canvas, and WebGL. This is the default. canvaskit - always use the CanvasKit renderer. This renderer uses WebGL and WebAssembly to render graphics. auto - use the HTML renderer on mobile devices, and CanvasKit on desktop devices. [auto (default), canvaskit, html]',
