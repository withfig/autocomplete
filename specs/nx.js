...
var processWorkspaceJson = function (filterFn) {
  return function (out) {
    try {
...
var nxGenerators = {
  ...
  appsAndLibs: {
    script: "cat workspace.json",
    postProcess: processWorkspaceJson(function () {
      return true;
    }),
  },
  localSchematics: {
  ...
  installedPlugins: {
    ...
    postProcess: function (out) {
      if (out.indexOf("Installed plugins") > -1) {
        ...
        plugins.shift();
        return plugins
          .map(function (pluginEntry) {
            return pluginEntry.trim().split(" ")[0];
          })
          .map(function (suggestion) {
            return {
              name: suggestion,
    ...
    postProcess: function (out, context) {
      if (out.indexOf("Installed plugins") > -1) {
        ...
        return lines
          ...
          .map(function (line) {
            return pluginArg_1 + line.trim().split(" : ")[0];
          })
          .map(function (suggestion) {
            return {
              name: suggestion,
