...
var configList = {
  ...
  postProcess: function (out) {
    ...
    try {
      ...
      if (configObject) {
        return Object.keys(configObject).map(function (key) {
          return { name: key };
        });
      }
    } catch (e) {}
...
var completionSpec = {
  ...
  generateSpec: function (_context, executeShellCommand) {
    return __awaiter(void 0, void 0, void 0, function () {
      var script, postProcess, packages, _a, cli, subcommands;
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            (script = packageList.script),
              (postProcess = packageList.postProcess);
            _a = postProcess;
