    ...
    subcommands: [
        {
            ...
            description: "Deletes the shadow for the specified thing. For more information, see DeleteThingShadow in the AWS IoT Developer Guide.",
            options: [
                {
                    name: "--thing-name",
        ...
        },
        {
            ...
            description: "Gets the shadow for the specified thing. For more information, see GetThingShadow in the AWS IoT Developer Guide.",
            options: [
                {
                    name: "--thing-name",
                    description: "The name of the thing.",
        ...
        {
            name: "publish",
            description: "Publishes state information. For more information, see HTTP Protocol in the AWS IoT Developer Guide.",
            options: [
                {
                    name: "--topic",
        ...
        },
        {
            ...
            description: "Updates the shadow for the specified thing. For more information, see UpdateThingShadow in the AWS IoT Developer Guide.",
            options: [
                {
                    name: "--thing-name",
                    description: "The name of the thing.",
