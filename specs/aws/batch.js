var completionSpec = {
    ...
    subcommands: [
        {
            name: "cancel-job",
            description: "Cancels a job in an AWS Batch job queue. Jobs that are in the SUBMITTED, PENDING, or RUNNABLE state are canceled. Jobs that have progressed to STARTING or RUNNING aren't canceled, but the API operation still succeeds, even if no job is canceled. These jobs must be terminated with the TerminateJob operation.",
            options: [
                {
                    name: "--job-id",
                ...
                {
                    name: "--reason",
                    description: "A message to attach to the job that explains the reason for canceling it. This message is returned by future DescribeJobs operations on the job. This message is also recorded in the AWS Batch activity logs.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Details about the compute resources managed by the compute environment. This parameter is required for managed compute environments. For more information, see Compute Environments in the AWS Batch User Guide.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--job-queue-name",
                    description: "The name of the job queue. Up to 128 letters (uppercase and lowercase), numbers, and underscores are allowed.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--tags",
                    description: "The tags that you apply to the job queue to help you categorize and organize your resources. Each tag consists of a key and an optional value. For more information, see Tagging your AWS Batch resources in AWS Batch User Guide.",
                    args: {
                        name: "map",
                    },
                },
        ...
        },
        {
            ...
            description: "Deregisters an AWS Batch job definition. Job definitions are permanently deleted after 180 days.",
            options: [
                {
                    name: "--job-definition",
        ...
        },
        {
            ...
            description: "Describes one or more of your compute environments. If you're using an unmanaged compute environment, you can use the DescribeComputeEnvironment operation to determine the ecsClusterArn that you should launch your Amazon ECS container instances into.",
            options: [
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--job-status",
                    description: "The job status used to filter jobs in the specified queue. If you don't specify a status, only RUNNING jobs are returned.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Lists the tags for an AWS Batch resource. AWS Batch resources that support tags are compute environments, jobs, job definitions, and job queues. ARNs for child jobs of array and multi-node parallel (MNP) jobs are not supported.",
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) that identifies the resource that tags are listed for. AWS Batch resources that support tags are compute environments, jobs, job definitions, and job queues. ARNs for child jobs of array and multi-node parallel (MNP) jobs are not supported.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--type",
                    description: "The type of job definition. For more information about multi-node parallel jobs, see Creating a multi-node parallel job definition in the AWS Batch User Guide.  If the job is run on Fargate resources, then multinode isn't supported.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--tags",
                    description: "The tags that you apply to the job definition to help you categorize and organize your resources. Each tag consists of a key and an optional value. For more information, see Tagging AWS Resources in AWS Batch User Guide.",
                    args: {
                        name: "map",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The array properties for the submitted job, such as the size of the array. The array size can be between 2 and 10,000. If you specify array properties for a job, it becomes an array job. For more information, see Array Jobs in the AWS Batch User Guide.",
                    args: {
                        name: "structure",
                    },
                },
                ...
                {
                    name: "--node-overrides",
                    description: "A list of node overrides in JSON format that specify the node range to target and the container overrides for that node range.  This parameter isn't applicable to jobs running on Fargate resources; use containerOverrides instead.",
                    args: {
                        name: "structure",
                    },
                },
                ...
                {
                    name: "--timeout",
                    description: "The timeout configuration for this SubmitJob operation. You can specify a timeout duration after which AWS Batch terminates your jobs if they haven't finished. If a job is terminated due to a timeout, it isn't retried. The minimum value for the timeout is 60 seconds. This configuration overrides any timeout configuration specified in the job definition. For array jobs, child jobs have the same timeout configuration as the parent job. For more information, see Job Timeouts in the Amazon Elastic Container Service Developer Guide.",
                    args: {
                        name: "structure",
                    },
                },
                {
                    name: "--tags",
                    description: "The tags that you apply to the job request to help you categorize and organize your resources. Each tag consists of a key and an optional value. For more information, see Tagging AWS Resources in AWS General Reference.",
                    args: {
                        name: "map",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) of the resource that tags are added to. AWS Batch resources that support tags are compute environments, jobs, job definitions, and job queues. ARNs for child jobs of array and multi-node parallel (MNP) jobs are not supported.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--tags",
                    description: "The tags that you apply to the resource to help you categorize and organize your resources. Each tag consists of a key and an optional value. For more information, see Tagging AWS Resources in AWS General Reference.",
                    args: {
                        name: "map",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) of the resource from which to delete tags. AWS Batch resources that support tags are compute environments, jobs, job definitions, and job queues. ARNs for child jobs of array and multi-node parallel (MNP) jobs are not supported.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--compute-resources",
                    description: "Details of the compute resources managed by the compute environment. Required for a managed compute environment. For more information, see Compute Environments in the AWS Batch User Guide.",
                    args: {
                        name: "structure",
                    },
                },
