    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--access-token",
                    description: "The token issued by the CreateToken API call. For more information, see CreateToken in the AWS SSO OIDC API Reference Guide.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        {
            name: "list-accounts",
            description: "Lists all AWS accounts assigned to the user. These AWS accounts are assigned by the administrator of the account. For more information, see Assign User Access in the AWS SSO User Guide. This operation returns a paginated response.",
            options: [
                {
                    name: "--next-token",
