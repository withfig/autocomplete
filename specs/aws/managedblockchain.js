    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--network-id",
                    description: "The unique identifier of the network for the node. Ethereum public networks have the following NetworkIds:    n-ethereum-mainnet     n-ethereum-rinkeby     n-ethereum-ropsten",
                    args: {
                        name: "string",
                    },
                },
        ...
        {
            name: "delete-node",
            description: "Deletes a node that your AWS account owns. All data on the node is lost and cannot be recovered. Applies to Hyperledger Fabric and Ethereum.",
            options: [
                {
                    name: "--network-id",
                    description: "The unique identifier of the network that the node is on. Ethereum public networks have the following NetworkIds:    n-ethereum-mainnet     n-ethereum-rinkeby     n-ethereum-ropsten",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns a list of all invitations for the current AWS account. Applies only to Hyperledger Fabric.",
            options: [
                {
                    name: "--max-results",
        ...
        {
            name: "list-networks",
            description: "Returns information about the networks in which the current AWS account participates. Applies to Hyperledger Fabric and Ethereum.",
            options: [
                {
                    name: "--name",
                    description: "The name of the network.",
        ...
        },
        {
            ...
            description: "Rejects an invitation to join a network. This action can be called by a principal in an AWS account that has received an invitation to create a member and join a network. Applies only to Hyperledger Fabric.",
            options: [
                {
                    name: "--invitation-id",
        ...
        },
        {
            ...
            description: "Casts a vote for a specified ProposalId on behalf of a member. The member to vote as, specified by VoterMemberId, must be in the same AWS account as the principal that calls the action. Applies only to Hyperledger Fabric.",
            options: [
                {
                    name: "--network-id",
                    description: "The unique identifier of the network.",
