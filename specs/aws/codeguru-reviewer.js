    ...
    subcommands: [
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "A KMSKeyDetails object that contains:   The encryption option for this repository association. It is either owned by AWS Key Management Service (KMS) (AWS_OWNED_CMK) or customer managed (CUSTOMER_MANAGED_CMK).   The ID of the AWS KMS key that is associated with this respository association.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Use to create a code review with a  CodeReviewType  of RepositoryAnalysis. This type of code review analyzes all code under a specified branch in an associated repository. PullRequest code reviews are automatically triggered by a pull request so cannot be created using this method.",
            options: [
                {
                    name: "--name",
                    description: "The name of the code review. The name of each code review in your AWS account must be unique.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--owners",
                    description: "List of owners to use as a filter. For AWS CodeCommit, it is the name of the CodeCommit account that was used to associate the repository. For other repository source providers, such as Bitbucket and GitHub Enterprise Server, this is name of the account that was used to associate the repository.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
