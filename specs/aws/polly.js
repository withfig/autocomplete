var completionSpec = {
    ...
    subcommands: [
        {
            name: "delete-lexicon",
            description: "Deletes the specified pronunciation lexicon stored in an AWS Region. A lexicon which has been deleted is not available for speech synthesis, nor is it possible to retrieve it using either the GetLexicon or ListLexicon APIs. For more information, see Managing Lexicons.",
            options: [
                {
                    name: "--name",
        ...
        {
            name: "get-lexicon",
            description: "Returns the content of the specified pronunciation lexicon stored in an AWS Region. For more information, see Managing Lexicons.",
            options: [
                {
                    name: "--name",
        ...
        {
            name: "list-lexicons",
            description: "Returns a list of pronunciation lexicons stored in an AWS Region. For more information, see Managing Lexicons.",
            options: [
                {
                    name: "--next-token",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--sample-rate",
                    description: 'The audio frequency specified in Hz. The valid values for mp3 and ogg_vorbis are "8000", "16000", "22050", and "24000". The default value for standard voices is "22050". The default value for neural voices is "24000". Valid values for pcm are "8000" and "16000" The default value is "16000".',
                    args: {
                        name: "string",
                    },
                    isOptional: true,
