    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The ID of the source backup. Specifies the ID of the backup that is being copied.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                {
                    name: "--source-region",
                    description: "The source AWS Region of the backup. Specifies the AWS Region from which the backup is being copied. The source and destination Regions must be in the same AWS partition. If you don't specify a Region, it defaults to the Region where the request is sent from (in-Region copy).",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--client-request-token",
                    description: "A string of up to 64 ASCII characters that Amazon FSx uses to ensure idempotent creation. This string is automatically filled on your behalf when you use the AWS Command Line Interface (AWS CLI) or an AWS SDK.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                },
                {
                    ...
                    description: "The type of Amazon FSx file system to create, either WINDOWS or LUSTRE.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                {
                    name: "--tags",
                    description: "The tags to apply to the file system being created. The key value of the Name tag appears in the console as the file system name.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
                ...
                },
                {
                    ...
                    description: "The Microsoft Windows configuration for the file system being created.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
        ...
        {
            name: "delete-backup",
            description: "Deletes an Amazon FSx backup, deleting its contents. After deletion, the backup no longer exists, and its data is gone. The DeleteBackup call returns instantly. The backup will not show up in later DescribeBackups calls.  The data in a deleted backup is also deleted and can't be recovered by any means.",
            options: [
                {
                    name: "--backup-id",
                ...
                {
                    name: "--client-request-token",
                    description: "A string of up to 64 ASCII characters that Amazon FSx uses to ensure idempotent deletion. This is automatically filled on your behalf when using the AWS CLI or SDK.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--backup-ids",
                    description: "IDs of the backups you want to retrieve (String). This overrides any filters. If any IDs are not found, BackupNotFound will be thrown.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
                ...
                {
                    name: "--filters",
                    description: "Filters structure. Supported names are file-system-id and backup-type.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
                ...
                {
                    name: "--max-results",
                    description: "Maximum number of backups to return in the response (integer). This parameter value must be greater than 0. The number of items that Amazon FSx returns is the minimum of the MaxResults parameter specified in the request and the service's internal maximum number of items per page.",
                    args: {
                        name: "integer",
                    },
                    isOptional: true,
                ...
                {
                    name: "--next-token",
                    description: "Opaque pagination token returned from a previous DescribeBackups operation (String). If a token present, the action continues the list from where the returning call left off.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--next-token",
                    description: "Opaque pagination token returned from a previous DescribeFileSystems operation (String). If a token present, the action continues the list from where the returning call left off.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--client-request-token",
                    description: "A string of up to 64 ASCII characters that Amazon FSx uses to ensure idempotent updates. This string is automatically filled on your behalf when you use the AWS Command Line Interface (AWS CLI) or an AWS SDK.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
