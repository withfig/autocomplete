    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--playback-mode",
                    description: "The type of playback mode for this channel. The only supported value is LOOP.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
            ...
            options: [
                {
                    ...
                    description: "An array of HTTP package configuration parameters for this VOD source.",
                    args: {
                        name: "list",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Provides details about a specific VOD source in a specific source location.",
            options: [
                {
                    name: "--source-location-name",
                    description: "The identifier for the source location you are working on.",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--http-package-configurations",
                    description: "An array of HTTP package configurations for the VOD source on this account.",
                    args: {
                        name: "list",
                    },
                    isOptional: false,
