    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                {
                    name: "--tags",
                    description: "The tags to assign to the new behavior graph. For each tag, you provide the tag key and the tag value.",
                    args: {
                        name: "map",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--graph-arn",
                    description: "The ARN of the behavior graph to invite the member accounts to contribute their data to.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                },
                {
                    ...
                    description: "if set to true, then the member accounts do not receive email notifications. By default, this is set to false, and the member accounts receive email notifications.",
                },
                {
                ...
                {
                    name: "--accounts",
                    description: "The list of AWS accounts to invite to become member accounts in the behavior graph. For each invited account, the account list contains the account identifier and the AWS account root user email address.",
                    args: {
                        name: "list",
                    },
                    isOptional: false,
        ...
        {
            name: "delete-graph",
            description: "Disables the specified behavior graph and queues it to be deleted. This operation removes the graph from each member account's list of behavior graphs.  DeleteGraph can only be called by the administrator account for a behavior graph.",
            options: [
                {
                    name: "--graph-arn",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--account-ids",
                    description: "The list of AWS account identifiers for the member accounts to delete from the behavior graph.",
                    args: {
                        name: "list",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Removes the member account from the specified behavior graph. This operation can only be called by a member account that has the ENABLED status.",
            options: [
                {
                    name: "--graph-arn",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--account-ids",
                    description: "The list of AWS account identifiers for the member account for which to return member details. You cannot use GetMembers to retrieve information about member accounts that were removed from the behavior graph.",
                    args: {
                        name: "list",
                    },
                    isOptional: false,
        ...
        {
            name: "list-members",
            description: "Retrieves the list of member accounts for a behavior graph. Does not return member accounts that were removed from the behavior graph.",
            options: [
                {
                    name: "--graph-arn",
        ...
        },
        {
            ...
            description: "Rejects an invitation to contribute the account data to a behavior graph. This operation must be called by a member account that has the INVITED status.",
            options: [
                {
                    name: "--graph-arn",
