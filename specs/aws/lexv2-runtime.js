var completionSpec = {
    ...
    subcommands: [
        ...
        {
            name: "put-session",
            description: "Creates a new session or modifies an existing session with an Amazon Lex bot. Use this operation to enable your application to set the state of the bot.",
            options: [
                {
                    name: "--bot-id",
                ...
                {
                    name: "--session-state",
                    description: "Sets the state of the session with the user. You can use this to set the current intent, attributes, context, and dialog action. Use the dialog action to determine the next step that Amazon Lex should use in the conversation with the user.",
                    args: {
                        name: "structure",
                    },
                    isOptional: false,
                },
                {
                    ...
                    description: "Request-specific information passed between Amazon Lex and the client application. The namespace x-amz-lex: is reserved for special attributes. Don't create any request attributes with the prefix x-amz-lex:.",
                    args: {
                        name: "map",
                    },
                    isOptional: true,
                },
                {
                    ...
                    description: "The message that Amazon Lex returns in the response can be either text or speech depending on the value of this parameter.    If the value is text/plain; charset=utf-8, Amazon Lex returns text in the response.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        {
            name: "recognize-text",
            description: "Sends user input to Amazon Lex. Client applications use this API to send requests to Amazon Lex at runtime. Amazon Lex then interprets the user input using the machine learning model that it build for the bot. In response, Amazon Lex returns the next message to convey to the user and an optional response card to display.",
            options: [
                {
                    name: "--bot-id",
                ...
                {
                    name: "--request-attributes",
                    description: "Request-specific information passed between the client application and Amazon Lex  The namespace x-amz-lex: is reserved for special attributes. Don't create any request attributes with the prefix x-amz-lex:.",
                    args: {
                        name: "map",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Sends user input to Amazon Lex. You can send text or speech. Clients use this API to send text and audio requests to Amazon Lex at runtime. Amazon Lex interprets the user input using the machine learning model built for the bot.",
            options: [
                {
                    name: "--bot-id",
                ...
                {
                    name: "--request-attributes",
                    description: "Request-specific information passed between the client application and Amazon Lex  The namespace x-amz-lex: is reserved for special attributes. Don't create any request attributes for prefix x-amz-lex:.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
