    ...
    subcommands: [
        {
            ...
            description: "Creates a backup plan using a backup plan name and backup rules. A backup plan is a document that contains information that AWS Backup uses to schedule tasks that create recovery points for resources. If you call CreateBackupPlan with a plan that already exists, an AlreadyExistsException is returned.",
            options: [
                {
                    name: "--backup-plan",
        ...
        },
        {
            ...
            description: "Creates a logical container where backups are stored. A CreateBackupVault request includes a name, optionally one or more resource tags, an encryption key, and a request ID.  Sensitive data, such as passport numbers, should not be included the name of a backup vault.",
            options: [
                {
        ...
        },
        {
            ...
            description: "Deletes the recovery point specified by a recovery point ID. If the recovery point ID belongs to a continuous backup, calling this endpoint deletes the existing continuous backup and stops future continuous backup.",
            options: [
                {
                    name: "--backup-vault-name",
                    description: "The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the AWS Region where they are created. They consist of lowercase letters, numbers, and hyphens.",
        ...
        },
        {
            ...
            description: "Deletes the specified continuous backup recovery point from AWS Backup and releases control of that continuous backup to the source service, such as Amazon RDS. The source service will continue to create and retain continuous backups using the lifecycle that you specified in your original backup plan. Does not support snapshot backup recovery points.",
            options: [
                {
                    name: "--backup-vault-name",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Returns only backup jobs for the specified resources:    DynamoDB for Amazon DynamoDB    EBS for Amazon Elastic Block Store    EC2 for Amazon Elastic Compute Cloud    EFS for Amazon Elastic File System    RDS for Amazon Relational Database Service    Aurora for Amazon Aurora    Storage Gateway for AWS Storage Gateway",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--by-account-id",
                    description: "The account ID to list the jobs from. Returns only backup jobs associated with the specified account ID. If used from an AWS Organizations management account, passing * returns all jobs across the organization.",
                    args: {
                        name: "string",
                    },
                },
        ...
        {
            name: "list-tags",
            description: "Returns a list of key-value pairs assigned to a target recovery point, backup plan, or backup vault.   ListTags are currently only supported with Amazon EFS backups.",
            options: [
                {
                    name: "--resource-arn",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "A customer chosen string that can be used to distinguish between calls to StartBackupJob.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--backup-options",
                    description: 'Specifies the backup option for a selected resource. This option is only available for Windows VSS backup jobs. Valid values: Set to "WindowsVSS\u201d:\u201cenabled" to enable WindowsVSS backup option and create a VSS Windows backup. Set to \u201cWindowsVSS\u201d:\u201ddisabled\u201d to create a regular backup. The WindowsVSS option is not enabled by default.',
                    args: {
                        name: "map",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--idempotency-token",
                    description: "A customer chosen string that can be used to distinguish between calls to StartCopyJob.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--iam-role-arn",
                    description: "The Amazon Resource Name (ARN) of the IAM role that AWS Backup uses to create the target recovery point; for example, arn:aws:iam::123456789012:role/S3Access.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--idempotency-token",
                    description: "A customer chosen string that can be used to distinguish between calls to StartRestoreJob.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Updates an existing backup plan identified by its backupPlanId with the input document in JSON format. The new version is uniquely identified by a VersionId.",
            options: [
                {
                    name: "--backup-plan-id",
                    description: "Uniquely identifies a backup plan.",
        ...
        },
        {
            ...
            description: "Updates the current global settings for the AWS account. Use the DescribeGlobalSettings API to determine the current settings.",
            options: [
                {
