    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--id",
                    description: "The identifier of the SQL statement to cancel. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API. This identifier is returned by ExecuteStatment and ListStatements.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--id",
                    description: "The identifier of the SQL statement to describe. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API. This identifier is returned by ExecuteStatment and ListStatements.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
            ...
            options: [
                {
                    ...
                    description: "The cluster identifier. This parameter is required when authenticating using either AWS Secrets Manager or temporary credentials.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                {
                    name: "--secret-arn",
                    description: "The name or ARN of the secret that enables access to the database. This parameter is required when authenticating using AWS Secrets Manager.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--database",
                    description: "The name of the database. This parameter is required when authenticating using temporary credentials.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--id",
                    description: "The identifier of the SQL statement whose results are to be fetched. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API. This identifier is returned by ExecuteStatment and ListStatements.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--statement-name",
                    description: "The name of the SQL statement specified as input to ExecuteStatement to identify the query. You can list multiple statements by providing a prefix that matches the beginning of the statement name. For example, to list myStatement1, myStatement2, myStatement3, and so on, then provide the a value of myStatement. Data API does a case-sensitive match of SQL statement names to the prefix value you provide.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
