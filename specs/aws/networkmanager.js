    ...
    subcommands: [
            ...
            options: [
                {
                    ...
                    description: "The Amazon Resource Name (ARN) of the customer gateway. For more information, see Resources Defined by Amazon EC2.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--vendor",
                    description: "The vendor of the device. Length Constraints: Maximum length of 128 characters.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--model",
                    description: "The model of the device. Length Constraints: Maximum length of 128 characters.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--serial-number",
                    description: "The serial number of the device. Length Constraints: Maximum length of 128 characters.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--type",
                    description: "The type of the link. Constraints: Cannot include the following characters: | \\ ^ Length Constraints: Maximum length of 128 characters.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--provider",
                    description: "The provider of the link. Constraints: Cannot include the following characters: | \\ ^ Length Constraints: Maximum length of 128 characters.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Deletes an existing global network. You must first delete all global network objects (devices, links, and sites) and deregister all transit gateways.",
            options: [
                {
                    name: "--global-network-id",
                    description: "The ID of the global network.",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "One or more customer gateway Amazon Resource Names (ARNs). For more information, see Resources Defined by Amazon EC2. The maximum is 10.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Registers a transit gateway in your global network. The transit gateway can be in any AWS Region, but it must be owned by the same AWS account that owns the global network. You cannot register a transit gateway in more than one global network.",
            options: [
                {
                    name: "--global-network-id",
                    description: "The ID of the global network.",
                ...
                {
                    name: "--transit-gateway-arn",
                    description: "The Amazon Resource Name (ARN) of the transit gateway. For more information, see Resources Defined by Amazon EC2.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--type",
                    description: "The type of the link. Length Constraints: Maximum length of 128 characters.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--provider",
                    description: "The provider of the link. Length Constraints: Maximum length of 128 characters.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
