    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "The file format of a dataset that is created from an S3 file or folder.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--path-options",
                    description: "A set of options that defines how DataBrew interprets an S3 path of the dataset.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The encryption mode for the job, which can be one of the following:    SSE-KMS - SSE-KMS - Server-side encryption with AWS KMS-managed keys.    SSE-S3 - Server-side encryption with keys managed by Amazon S3.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--role-arn",
                    description: "The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role to be assumed when DataBrew runs the job.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Creates a new job to transform input data, using steps defined in an existing AWS Glue DataBrew recipe",
            options: [
                {
                    name: "--dataset-name",
                ...
                {
                    name: "--encryption-mode",
                    description: "The encryption mode for the job, which can be one of the following:    SSE-KMS - Server-side encryption with keys managed by AWS KMS.    SSE-S3 - Server-side encryption with keys managed by Amazon S3.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The date or dates and time or times when the jobs are to be run. For more information, see Cron expressions in the AWS Glue DataBrew Developer Guide.",
                    args: {
                        name: "string",
                    },
                },
