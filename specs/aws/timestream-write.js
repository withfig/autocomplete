    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--kms-key-id",
                    description: "The KMS key for the database. If the KMS key is not specified, the database will be encrypted with a Timestream managed KMS key located in your account. Refer to AWS managed KMS keys for more info.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns information about the database, including the database name, time that the database was created, and the total number of tables found within the database. Service quotas apply. For more information, see Access Management in the Timestream Developer Guide.",
            options: [
                {
                    name: "--database-name",
                    description: "The name of the Timestream database.",
        ...
        {
            name: "describe-table",
            description: "Returns information about the table, including the table name, database name, retention duration of the memory store and the magnetic store. Service quotas apply. For more information, see Access Management in the Timestream Developer Guide.",
            options: [
                {
                    name: "--database-name",
                    description: "The name of the Timestream database.",
        ...
        {
            name: "list-databases",
            description: "Returns a list of your Timestream databases. Service quotas apply. For more information, see Access Management in the Timestream Developer Guide.",
            options: [
                {
                    name: "--next-token",
        ...
        {
            name: "list-tables",
            description: "A list of tables, along with the name, status and retention properties of each table.",
            options: [
                {
                    name: "--database-name",
                    description: "The name of the Timestream database.",
        ...
        },
        {
            ...
            description: "Modifies the KMS key for an existing database. While updating the database, you must specify the database name and the identifier of the new KMS key to be used (KmsKeyId). If there are any concurrent UpdateDatabase requests, first writer wins.",
            options: [
                {
                    name: "--database-name",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "A record containing the common measure and dimension attributes shared across all the records in the request. The measure and dimension attributes specified in here will be merged with the measure and dimension attributes in the records object when the data is written into Timestream.",
                    args: {
                        name: "structure",
                    },
                },
                {
                    name: "--records",
                    description: "An array of records containing the unique dimension and measure attributes for each time series data point.",
                    args: {
                        name: "list",
                    },
                },
