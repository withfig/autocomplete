    ...
    subcommands: [
        {
            ...
            description: "Creates a batch inference job. The operation can handle up to 50 million records and the input file must be in JSON format. For more information, see recommendations-batch.",
            options: [
                {
                    name: "--job-name",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--dataset-type",
                    description: "The type of dataset. One of the following (case insensitive) values:   Interactions   Items   Users",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--role-arn",
                    description: "The Amazon Resource Name (ARN) of the AWS Identity and Access Management service role that has permissions to add data to your output Amazon S3 bucket.",
                    args: {
                        name: "string",
                    },
                },
        ...
        {
            name: "create-filter",
            description: "Creates a recommendation filter. For more information, see filter.",
            options: [
                {
                    name: "--name",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The configuration to use with the solution. When performAutoML is set to true, Amazon Personalize only evaluates the autoMLConfig section of the solution configuration.  Amazon Personalize doesn't support configuring the hpoObjective at this time.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            description: "Removes a campaign by deleting the solution deployment. The solution that the campaign is based on is not deleted and can be redeployed when needed. A deleted campaign can no longer be specified in a GetRecommendations request. For more information on campaigns, see CreateCampaign.",
            options: [
                {
                    name: "--campaign-arn",
        ...
        },
        {
            ...
            description: "Deletes the event tracker. Does not delete the event-interactions dataset from the associated dataset group. For more information on event trackers, see CreateEventTracker.",
            options: [
                {
        ...
        },
        {
            ...
            description: "Updates a campaign by either deploying a new solution or changing the value of the campaign's minProvisionedTPS parameter. To update a campaign, the campaign status must be ACTIVE or CREATE FAILED. Check the campaign status using the DescribeCampaign API.  You must wait until the status of the updated campaign is ACTIVE before asking the campaign for recommendations.  For more information on campaigns, see CreateCampaign.",
            options: [
                {
                    name: "--campaign-arn",
                    description: "The Amazon Resource Name (ARN) of the campaign.",
