var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Disassociates the account that has been set as the AWS Firewall Manager administrator account. To set a different account as the administrator account, you must submit an AssociateAdminAccount request.",
            options: [
                {
                    name: "--cli-input-json",
                    description: "Performs service operation based on the JSON string provided. The JSON string follows the format provided by ``--generate-cli-skeleton``. If other arguments are provided on the command line, the CLI values will override the JSON-provided values. It is not possible to pass arbitrary binary values using a JSON-provided value as the string will be taken literally.",
        ...
        {
            name: "get-apps-list",
            description: "Returns information about the specified AWS Firewall Manager applications list.",
            options: [
                {
                    name: "--list-id",
                    description: "The ID of the AWS Firewall Manager applications list that you want the details for.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                {
                    name: "--default-list",
                    description: "Specifies whether the list to retrieve is a default list owned by AWS Firewall Manager.",
                },
                {
        ...
        },
        {
            ...
            description: "Returns detailed compliance information about the specified member account. Details include resources that are in and out of compliance with the specified policy. Resources are considered noncompliant for AWS WAF and Shield Advanced policies if the specified policy has not been applied to them. Resources are considered noncompliant for security group policies if they are in scope of the policy, they violate one or more of the policy rules, and remediation is disabled or not possible. Resources are considered noncompliant for Network Firewall policies if a firewall is missing in the VPC, if the firewall endpoint isn't set up in an expected Availability Zone and subnet, if a subnet created by the Firewall Manager doesn't have the expected route table, and for modifications to a firewall policy that violate the Firewall Manager policy's rules.",
            options: [
                {
                    name: "--policy-id",
        ...
        },
        {
            ...
            description: "Information about the Amazon Simple Notification Service (SNS) topic that is used to record AWS Firewall Manager SNS logs.",
            options: [
                {
                    name: "--cli-input-json",
                    description: "Performs service operation based on the JSON string provided. The JSON string follows the format provided by ``--generate-cli-skeleton``. If other arguments are provided on the command line, the CLI values will override the JSON-provided values. It is not possible to pass arbitrary binary values using a JSON-provided value as the string will be taken literally.",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The AWS account that is in scope of the policy that you want to get the details for.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--start-time",
                    description: "The start of the time period to query for the attacks. This is a timestamp type. The request syntax listing indicates a number type because the default used by AWS Firewall Manager is Unix time in seconds. However, any valid timestamp format is allowed.",
                    args: {
                        name: "timestamp",
                    },
                    isOptional: true,
                ...
                {
                    name: "--end-time",
                    description: "The end of the time period to query for the attacks. This is a timestamp type. The request syntax listing indicates a number type because the default used by AWS Firewall Manager is Unix time in seconds. However, any valid timestamp format is allowed.",
                    args: {
                        name: "timestamp",
                    },
                    isOptional: true,
                ...
                {
                    name: "--next-token",
                    description: "If you specify a value for MaxResults and you have more objects than the number that you specify for MaxResults, AWS Firewall Manager returns a NextToken value in the response, which you can use to retrieve another group of objects. For the second and subsequent GetProtectionStatus requests, specify the value of NextToken from the previous response to get information about another batch of objects.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--max-results",
                    description: "Specifies the number of objects that you want AWS Firewall Manager to return for this request. If you have more objects than the number that you specify for MaxResults, the response includes a NextToken value that you can use to get another batch of objects.",
                    args: {
                        name: "integer",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Returns information about the specified AWS Firewall Manager protocols list.",
            options: [
                {
                    name: "--list-id",
                    description: "The ID of the AWS Firewall Manager protocols list that you want the details for.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Retrieves violations for a resource based on the specified AWS Firewall Manager policy and AWS account.",
            options: [
                {
                    name: "--policy-id",
                    description: "The ID of the AWS Firewall Manager policy that you want the details for. This currently only supports security group content audit policies.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                {
                    name: "--resource-type",
                    description: "The resource type. This is in the format shown in the AWS Resource Types Reference. Supported resource types are: AWS::EC2::Instance, AWS::EC2::NetworkInterface, AWS::EC2::SecurityGroup, AWS::NetworkFirewall::FirewallPolicy, and AWS::EC2::Subnet.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--default-lists",
                    description: "Specifies whether the lists to retrieve are default lists owned by AWS Firewall Manager.",
                },
                {
                ...
                {
                    name: "--max-results",
                    description: "The maximum number of objects that you want AWS Firewall Manager to return for this request. If more objects are available, in the response, AWS Firewall Manager provides a NextToken value that you can use in a subsequent call to get the next batch of objects. If you don't specify this, AWS Firewall Manager returns all available objects.",
                    args: {
                        name: "integer",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "Specifies the number of PolicyComplianceStatus objects that you want AWS Firewall Manager to return for this request. If you have more PolicyComplianceStatus objects than the number that you specify for MaxResults, the response includes a NextToken value that you can use to get another batch of PolicyComplianceStatus objects.",
                    args: {
                        name: "integer",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Returns a MemberAccounts object that lists the member accounts in the administrator's AWS organization. The ListMemberAccounts must be submitted by the account that is set as the AWS Firewall Manager administrator.",
            options: [
                {
                    name: "--next-token",
                    description: "If you specify a value for MaxResults and you have more account IDs than the number that you specify for MaxResults, AWS Firewall Manager returns a NextToken value in the response that allows you to list another group of IDs. For the second and subsequent ListMemberAccountsRequest requests, specify the value of NextToken from the previous response to get information about another batch of member account IDs.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--max-results",
                    description: "Specifies the number of member account IDs that you want AWS Firewall Manager to return for this request. If you have more IDs than the number that you specify for MaxResults, the response includes a NextToken value that you can use to get another batch of member account IDs.",
                    args: {
                        name: "integer",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--next-token",
                    description: "If you specify a value for MaxResults and you have more PolicySummary objects than the number that you specify for MaxResults, AWS Firewall Manager returns a NextToken value in the response that allows you to list another group of PolicySummary objects. For the second and subsequent ListPolicies requests, specify the value of NextToken from the previous response to get information about another batch of PolicySummary objects.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--max-results",
                    description: "Specifies the number of PolicySummary objects that you want AWS Firewall Manager to return for this request. If you have more PolicySummary objects than the number that you specify for MaxResults, the response includes a NextToken value that you can use to get another batch of PolicySummary objects.",
                    args: {
                        name: "integer",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) of the resource to return tags for. The AWS Firewall Manager resources that support tagging are policies, applications lists, and protocols lists.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--apps-list",
                    description: "The details of the AWS Firewall Manager applications list to be created.",
                    args: {
                        name: "structure",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--protocols-list",
                    description: "The details of the AWS Firewall Manager protocols list to be created.",
                    args: {
                        name: "structure",
                    },
                    isOptional: false,
