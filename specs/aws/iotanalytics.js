    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Where channel data is stored. You can choose one of serviceManagedS3 or customerManagedS3 storage. If not specified, the default is serviceManagedS3. You cannot change this storage option after the channel is created.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--triggers",
                    description: "A list of triggers. A trigger causes data set contents to be populated at a specified time interval or when another data set's contents are created. The list of triggers can be empty or contain up to five DataSetTrigger objects.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
                ...
                {
                    name: "--retention-period",
                    description: "Optional. How long, in days, versions of dataset contents are kept for the dataset. If not specified or set to null, versions of dataset contents are retained for at most 90 days. The number of versions of dataset contents retained is determined by the versioningConfiguration parameter. For more information, see Keeping Multiple Versions of AWS IoT Analytics Data Sets in the AWS IoT Analytics User Guide.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
                ...
                },
                {
                    ...
                    description: "A list of data rules that send notifications to Amazon CloudWatch, when data arrives late. To specify lateDataRules, the dataset must use a DeltaTimer filter.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Where data store data is stored. You can choose one of serviceManagedS3 or customerManagedS3 storage. If not specified, the default is serviceManagedS3. You cannot change this storage option after the data store is created.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
                ...
                },
                {
                    ...
                    description: "Contains the configuration information of file formats. AWS IoT Analytics data stores support JSON and Parquet. The default file format is JSON. You can specify only one format. You can't change the file format after you create the data store.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Retrieves the contents of a data set as presigned URIs.",
            options: [
                {
                    name: "--dataset-name",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "A filter to limit results to those data set contents whose creation is scheduled on or after the given time. See the field triggers.schedule in the CreateDataset request. (timestamp)",
                    args: {
                        name: "timestamp",
                    },
                    isOptional: true,
                },
                {
                    ...
                    description: "A filter to limit results to those data set contents whose creation is scheduled before the given time. See the field triggers.schedule in the CreateDataset request. (timestamp)",
                    args: {
                        name: "timestamp",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--datastore-storage",
                    description: "Where data store data is stored. You can choose one of serviceManagedS3 or customerManagedS3 storage. If not specified, the default isserviceManagedS3. You cannot change this storage option after the data store is created.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
