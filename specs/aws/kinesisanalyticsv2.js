    ...
    subcommands: [
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The version ID of the Kinesis Data Analytics application. You can retrieve the application version ID using DescribeApplication.",
                    args: {
                        name: "long",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--current-application-version-id",
                    description: "The current version of your application. You can use the DescribeApplication operation to find the current application version.",
                    args: {
                        name: "long",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Adds an InputProcessingConfiguration to a SQL-based Kinesis Data Analytics application. An input processor pre-processes records on the input stream before the application's SQL code executes. Currently, the only input processor available is AWS Lambda.",
            options: [
                {
                    name: "--application-name",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--current-application-version-id",
                    description: "The version of the application to which you want to add the VPC configuration. You can use the DescribeApplication operation to get the current application version. If the version specified is not the current version, the ConcurrentModificationException is returned.",
                    args: {
                        name: "long",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Creates a Kinesis Data Analytics application. For information about creating a Kinesis Data Analytics application, see Creating an Application.",
            options: [
                {
                    name: "--application-name",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--current-application-version-id",
                    description: "The version ID of the application. You can retrieve the application version ID using DescribeApplication.",
                    args: {
                        name: "long",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Returns information about a specific Kinesis Data Analytics application. If you want to retrieve a list of all applications in your account, use the ListApplications operation.",
            options: [
                {
                    name: "--application-name",
                    description: "The name of the application.",
        ...
        },
        {
            ...
            description: "Returns a list of Kinesis Data Analytics applications in your account. For each application, the response includes the application name, Amazon Resource Name (ARN), and status.  If you want detailed information about a specific application, use DescribeApplication.",
            options: [
                {
                    name: "--limit",
                ...
                {
                    name: "--next-token",
                    description: "If a previous command returned a pagination token, pass it into this value to retrieve the next set of results. For more information about pagination, see Using the AWS Command Line Interface's Pagination Options.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        {
            name: "tag-resource",
            description: "Adds one or more key-value tags to a Kinesis Data Analytics application. Note that the maximum number of application tags includes system tags. The maximum number of user-defined application tags is 50. For more information, see Using Tagging.",
            options: [
                {
                    name: "--resource-arn",
        ...
        {
            name: "untag-resource",
            description: "Removes one or more tags from a Kinesis Data Analytics application. For more information, see Using Tagging.",
            options: [
                {
                    name: "--resource-arn",
        ...
        },
        {
            ...
            description: "Updates the configuration for the automatic maintenance that Kinesis Data Analytics performs on the application. For information about automatic application maintenance, see Kinesis Data Analytics for Apache Flink Maintenance.",
            options: [
                {
                    name: "--application-name",
                    description: "The name of the application for which you want to update the maintenance time window.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
