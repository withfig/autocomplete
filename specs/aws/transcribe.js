    ...
    subcommands: [
        {
            ...
            description: "Creates a new custom language model. Use Amazon S3 prefixes to provide the location of your input files. The time it takes to create your model depends on the size of your training data.",
            options: [
                {
                    name: "--language-code",
                    description: "The language of the input text you're using to train your custom language model.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--model-name",
                    description: "The name you choose for your custom language model when you create it.",
                    args: {
                        name: "string",
                    },
                },
                {
                    ...
                    description: "Contains the data access role and the Amazon S3 prefixes to read the required input files to create a custom language model.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            description: "Creates a new custom vocabulary that you can use to change how Amazon Transcribe Medical transcribes your audio file.",
            options: [
                {
                    name: "--vocabulary-name",
                    description: "The name of the custom vocabulary. This case-sensitive name must be unique within an AWS account. If you try to create a vocabulary with the same name as a previous vocabulary, you get a ConflictException error.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--language-code",
                    description: "The language code for the language used for the entries in your custom vocabulary. The language code of your custom vocabulary must match the language code of your transcription job. US English (en-US) is the only language code available for Amazon Transcribe Medical.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--vocabulary-name",
                    description: "The name of the vocabulary. The name must be unique within an AWS account. The name is case sensitive. If you try to create a vocabulary with the same name as a previous vocabulary you will receive a ConflictException error.",
                    args: {
                        name: "string",
                    },
                },
            ...
            options: [
                {
                    ...
                    description: "The vocabulary filter name. The name must be unique within the account that contains it. If you try to create a vocabulary filter with the same name as another vocabulary filter, you get a ConflictException error.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--words",
                    description: "The words to use in the vocabulary filter. Only use characters from the character set defined for custom vocabularies. For a list of character sets, see Character Sets for Custom Vocabularies. If you provide a list of words in the Words parameter, you can't use the VocabularyFilterFileUri parameter.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Deletes a transcription job generated by Amazon Transcribe Medical and any related information.",
            options: [
                {
                    name: "--medical-transcription-job-name",
                    description: "The name you provide to the DeleteMedicalTranscriptionJob object to delete a transcription job.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--model-name",
                    description: "The name of the custom language model you submit to get more information.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns information about a transcription job from Amazon Transcribe Medical. To see the status of the job, check the TranscriptionJobStatus field. If the status is COMPLETED, the job is finished. You find the results of the completed job in the TranscriptFileUri field.",
            options: [
                {
                    name: "--medical-transcription-job-name",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--vocabulary-name",
                    description: "The name of the vocabulary that you want information about. The value is case sensitive.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Provides more information about the custom language models you've created. You can use the information in this list to find a specific custom language model. You can then use the operation to get more information about it.",
            options: [
                {
                    name: "--status-equals",
                    description: "When specified, returns only custom language models with the specified status. Language models are ordered by creation date, with the newest models first. If you don't specify a status, Amazon Transcribe returns all custom language models ordered by date.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--name-contains",
                    description: "When specified, the custom language model names returned contain the substring you've specified.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--next-token",
                    description: "When included, fetches the next set of jobs if the result of the previous request was truncated.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--max-results",
                    description: "The maximum number of language models to return in the response. If there are fewer results in the list, the response contains only the actual results.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Lists medical transcription jobs with a specified status or substring that matches their names.",
            options: [
                {
                    name: "--status",
                    description: "When specified, returns only medical transcription jobs with the specified status. Jobs are ordered by creation date, with the newest jobs returned first. If you don't specify a status, Amazon Transcribe Medical returns all transcription jobs ordered by creation date.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--next-token",
                    description: "If you a receive a truncated result in the previous request of ListMedicalTranscriptionJobs, include NextToken to fetch the next set of jobs.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--max-results",
                    description: "The maximum number of medical transcription jobs to return in the response. IF there are fewer results in the list, this response contains only the actual results.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns a list of vocabularies that match the specified criteria. If you don't enter a value in any of the request parameters, returns the entire list of vocabularies.",
            options: [
                {
                    name: "--next-token",
                    description: "If the result of your previous request to ListMedicalVocabularies was truncated, include the NextToken to fetch the next set of vocabularies.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--max-results",
                    description: "The maximum number of vocabularies to return in the response.",
                    args: {
                        name: "integer",
                    },
                },
                {
                    name: "--state-equals",
                    description: "When specified, returns only vocabularies with the VocabularyState equal to the specified vocabulary state. Use this field to see which vocabularies are ready for your medical transcription jobs.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--name-contains",
                    description: 'Returns vocabularies whose names contain the specified string. The search is not case sensitive. ListMedicalVocabularies returns both "vocabularyname" and "VocabularyName".',
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--next-token",
                    description: "If the result of the previous request to ListTranscriptionJobs was truncated, include the NextToken to fetch the next set of jobs.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--next-token",
                    description: "If the result of the previous request to ListVocabularies was truncated, include the NextToken to fetch the next set of jobs.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--state-equals",
                    description: "When specified, only returns vocabularies with the VocabularyState field equal to the specified state.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--name-contains",
                    description: 'When specified, the vocabularies returned in the list are limited to vocabularies whose name contains the specified string. The search is not case sensitive, ListVocabularies returns both "vocabularyname" and "VocabularyName" in the response list.',
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--next-token",
                    description: "If the result of the previous request to ListVocabularyFilters was truncated, include the NextToken to fetch the next set of collections.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--language-code",
                    description: "The language code for the language spoken in the input media file. US English (en-US) is the valid value for medical transcription jobs. Any other value you enter for language code results in a BadRequestException error.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--specialty",
                    description: "The medical specialty of any clinician speaking in the input media.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--type",
                    description: "The type of speech in the input audio. CONVERSATION refers to conversations between two or more speakers, e.g., a conversations between doctors and patients. DICTATION refers to single-speaker dictated speech, e.g., for clinical notes.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--transcription-job-name",
                    description: 'The name of the job. You can\'t use the strings "." or ".." by themselves as the job name. The name must also be unique within an AWS account. If you try to create a transcription job with the same name as a previous transcription job, you get a ConflictException error.',
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--settings",
                    description: "A Settings object that provides optional settings for a transcription job.",
                    args: {
                        name: "structure",
                    },
                },
                {
                    name: "--model-settings",
                    description: "Choose the custom language model you use for your transcription job in this parameter.",
                    args: {
                        name: "structure",
                    },
                },
                ...
                },
                {
                    ...
                    description: "Set this field to true to enable automatic language identification. Automatic language identification is disabled by default. You receive a BadRequestException error if you enter a value for a LanguageCode.",
                },
                {
                ...
                },
                {
                    ...
                    description: "An object containing a list of languages that might be present in your collection of audio files. Automatic language identification chooses a language that best matches the source audio from that list.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Updates a vocabulary with new values that you provide in a different text file from the one you used to create the vocabulary. The UpdateMedicalVocabulary operation overwrites all of the existing information with the values that you provide in the request.",
            options: [
                {
                    name: "--vocabulary-name",
                    description: "The name of the vocabulary to update. The name is case sensitive. If you try to update a vocabulary with the same name as a vocabulary you've already made, you get a ConflictException error.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--language-code",
                    description: "The language code of the language used for the entries in the updated vocabulary. US English (en-US) is the only valid language code in Amazon Transcribe Medical.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--vocabulary-name",
                    description: "The name of the vocabulary to update. The name is case sensitive. If you try to update a vocabulary with the same name as a previous vocabulary you will receive a ConflictException error.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--vocabulary-filter-name",
                    description: "The name of the vocabulary filter to update. If you try to update a vocabulary filter with the same name as another vocabulary filter, you get a ConflictException error.",
                    args: {
                        name: "string",
                    },
                },
