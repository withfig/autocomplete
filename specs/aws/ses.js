    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--rule-set-name",
                    description: "The name of the rule set to create. The name must:   This value can only contain ASCII letters (a-z, A-Z), numbers (0-9), underscores (_), or dashes (-).   Start and end with a letter or number.   Contain less than 64 characters.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--configuration-set-name",
                    description: "The name of the configuration set from which you want to delete the tracking options.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "The maximum number of custom verification email templates to return. This value must be at least 1 and less than or equal to 50. If you do not specify a value, or if you specify a value less than 1 or greater than 50, the operation will return up to 50 results.",
                    args: {
                        name: "integer",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Returns a list containing all of the identities (email addresses and domains) for your AWS account in the current AWS Region, regardless of verification status. You can execute this operation no more than once per second.",
            options: [
                {
                    name: "--identity-type",
        ...
        },
        {
            ...
            description: "Lists the IP address filters associated with your AWS account in the current AWS Region. For information about managing IP address filters, see the Amazon SES Developer Guide. You can execute this operation no more than once per second.",
            options: [
                {
                    name: "--cli-input-json",
                    description: "Performs service operation based on the JSON string provided. The JSON string follows the format provided by ``--generate-cli-skeleton``. If other arguments are provided on the command line, the CLI values will override the JSON-provided values. It is not possible to pass arbitrary binary values using a JSON-provided value as the string will be taken literally.",
        ...
        {
            name: "list-templates",
            description: "Lists the email templates present in your Amazon SES account in the current AWS Region. You can execute this operation no more than once per second.",
            options: [
                {
                    name: "--next-token",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--configuration-set-name",
                    description: "The name of the configuration set that you want to specify the delivery options for.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--identity",
                    description: "The identity that the policy will apply to. You can specify an identity by using its name or by using its Amazon Resource Name (ARN). Examples: user@example.com, example.com, arn:aws:ses:us-east-1:123456789012:identity/example.com. To successfully call this API, you must own the identity.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--destinations",
                    description: "One or more Destination objects. All of the recipients in a Destination will receive the same version of the email. You can specify up to 50 Destination objects within a Destinations array.",
                    args: {
                        name: "list",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--source",
                    description: 'The identity\'s email address. If you do not provide a value for this parameter, you must specify a "From" address in the raw text of the message. (You can also specify both.)  Amazon SES does not support the SMTPUTF8 extension, as described inRFC6531. For this reason, the local part of a source email address (the part of the email address that precedes the @ sign) may only contain 7-bit ASCII characters. If the domain part of an address (the part after the @ sign) contains non-ASCII characters, they must be encoded using Punycode, as described in RFC3492. The sender name (also known as the friendly name) may contain non-ASCII characters. These characters must be encoded using MIME encoded-word syntax, as described in RFC 2047. MIME encoded-word syntax uses the following form: =?charset?encoding?encoded-text?=.  If you specify the Source parameter and have feedback forwarding enabled, then bounces and complaints will be sent to this email address. This takes precedence over any Return-Path header that you might include in the raw text of the message.',
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--identity",
                    description: "The identity (email address or domain) that you want to set the Amazon SNS topic for.  You can only specify a verified identity for this parameter.  You can specify an identity by using its name or by using its Amazon Resource Name (ARN). The following examples are all valid identities: sender@example.com, example.com, arn:aws:ses:us-east-1:123456789012:identity/example.com.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--enabled",
                    description: "Describes whether email sending is enabled or disabled for your Amazon SES account in the current AWS Region.",
                },
                {
                    name: "--no-enabled",
                    description: "Describes whether email sending is enabled or disabled for your Amazon SES account in the current AWS Region.",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--enabled",
                    description: "Describes whether or not Amazon SES will publish reputation metrics for the configuration set, such as bounce and complaint rates, to Amazon CloudWatch.",
                },
                {
                    name: "--no-enabled",
                    description: "Describes whether or not Amazon SES will publish reputation metrics for the configuration set, such as bounce and complaint rates, to Amazon CloudWatch.",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--configuration-set-name",
                    description: "The name of the configuration set for which you want to update the custom tracking domain.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Adds an email address to the list of identities for your Amazon SES account in the current AWS region and attempts to verify it. As a result of executing this operation, a verification email is sent to the specified address. You can execute this operation no more than once per second.",
            options: [
                {
                    name: "--email-address",
