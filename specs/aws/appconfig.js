var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Stops a deployment. This API action works only on deployments that have a status of DEPLOYING. This action moves the deployment to a status of ROLLED_BACK.",
            options: [
                {
                    name: "--application-id",
                    description: "The application ID.",
