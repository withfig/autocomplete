var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Lists agents or connectors as specified by ID or other filters. All agents/connectors associated with your user account can be listed if you call DescribeAgents as is without passing any parameters.",
            options: [
                {
                    name: "--agent-ids",
        ...
        },
        {
            ...
            description: "DescribeExportConfigurations is deprecated. Use DescribeImportTasks, instead.",
            options: [
                {
                    name: "--export-ids",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--import-url",
                    description: "The URL for your import file that you've uploaded to Amazon S3.  If you're using the AWS CLI, this URL is structured as follows: s3://BucketName/ImportFileName.CSV",
                    args: {
                        name: "string",
                    },
                },
