...
var listCustomGenerator = function (context, executeShellCommand, command, options, parentKey, childKey) {
    ...
    return __awaiter(void 0, void 0, Promise, function () {
        var cmd, i, option, idx, param, out, list, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, list.map(function (elm) {
                            var name = (childKey ? elm[childKey] : elm);
                            return {
                                name: name,
                                icon: "fig://icon?type=aws",
...
var generators = {
    ...
    getFunctionRevisionId: {
        custom: function (context, executeShellCommand) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, listCustomGenerator(context, executeShellCommand, "get-function", ["--function-name"], "Configuration", "RevisionId")];
                });
            });
        },
        cache: {
    ...
    listVersions: {
        custom: function (context, executeShellCommand) {
            return __awaiter(this, void 0, void 0, function () {
                var idx, cmd, out, list, e_4;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            idx = context.indexOf("--function-name");
                            cmd = "aws lambda list-versions-by-function --function-name " + context[idx + 1];
                            return [4 /*yield*/, executeShellCommand(cmd)];
                        case 1:
                            out = _a.sent();
    ...
    listLayerArnsWithVersion: {
        ...
        postProcess: function (out) {
            try {
                var list = JSON.parse(out)["Layers"];
                return list.map(function (elm) {
                    return {
    ...
    listFilesystemConfigs: {
        ...
        postProcess: function (out) {
            try {
                var list = JSON.parse(out)["FileSystems"];
                return list.map(function (elm) {
                    var name = ("FileSystemArn" ? elm["FileSystemArn"] : elm);
                    return {
...
var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The position in a stream from which to start reading. Required for Amazon Kinesis, Amazon DynamoDB, and Amazon MSK Streams sources. AT_TIMESTAMP is only supported for Amazon Kinesis streams.",
                    args: {
                        name: "string",
                ...
                },
                {
                    ...
                    description: "(Streams) The duration in seconds of a processing window. The range is between 1 second up to 900 seconds.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    args: {
                        name: "structure",
                        description: "S3Bucket=string,S3Key=string,S3ObjectVersion=string,ImageUri=string",
                    },
                },
                {
                    name: "--description",
        ...
        },
        {
            ...
            description: "Deletes a Lambda function. To delete a specific function version, use the Qualifier parameter. Otherwise, all versions and aliases are deleted. To delete Lambda event source mappings that invoke a function, use DeleteEventSourceMapping. For AWS services and resources that invoke your function directly, delete the trigger in the service where you originally configured it.",
            options: [
                {
                    name: "--function-name",
                    description: "The name of the Lambda function or version.  Name formats     Function name - my-function (name-only), my-function:1 (with version).    Function ARN - arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN - 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.",
                    args: {
                        name: "string",
                        generators: generators.listLambdaFunctions,
                    },
        ...
        },
        {
            ...
            description: "Deletes a version of an AWS Lambda layer. Deleted versions can no longer be viewed or added to functions. To avoid breaking functions, a copy of the version remains in Lambda until no functions refer to it.",
            options: [
                {
                    name: "--layer-name",
                    description: "The name or Amazon Resource Name (ARN) of the layer.",
        ...
        },
        {
            ...
            description: "Returns information about a version of an AWS Lambda layer, with a link to download the layer archive that's valid for 10 minutes.",
            options: [
                {
                    name: "--layer-name",
                    description: "The name or Amazon Resource Name (ARN) of the layer.",
        ...
        },
        {
            ...
            description: "Returns the permission policy for a version of an AWS Lambda layer. For more information, see AddLayerVersionPermission.",
            options: [
                {
                    name: "--layer-name",
                    description: "The name or Amazon Resource Name (ARN) of the layer.",
        ...
        },
        {
            ...
            description: "Lists event source mappings. Specify an EventSourceArn to only show event source mappings for a single event source.",
            options: [
                {
                    name: "--event-source-arn",
                    description: "The Amazon Resource Name (ARN) of the event source.    Amazon Kinesis - The ARN of the data stream or a stream consumer.    Amazon DynamoDB Streams - The ARN of the stream.    Amazon Simple Queue Service - The ARN of the queue.    Amazon Managed Streaming for Apache Kafka - The ARN of the cluster.",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--master-region",
                    description: "For Lambda@Edge functions, the AWS Region of the master function. For example, us-east-1 filters the list of functions to only include Lambda@Edge functions replicated from a master function in US East (N. Virginia). If specified, you must set FunctionVersion to ALL.",
                    args: {
                        name: "string",
        ...
        },
        {
            ...
            description: "Lists the versions of an AWS Lambda layer. Versions that have been deleted aren't listed. Specify a runtime identifier to list only versions that indicate that they're compatible with that runtime.",
            options: [
                {
        ...
        {
            name: "list-layers",
            description: "Lists AWS Lambda layers and shows information about the latest version of each. Specify a runtime identifier to list only layers that indicate that they're compatible with that runtime.",
            options: [
                {
                    name: "--compatible-runtime",
                    description: "A runtime identifier. For example, go1.x.",
        ...
        },
        {
            ...
            description: "Creates an AWS Lambda layer from a ZIP archive. Each time you call PublishLayerVersion with the same layer name, a new version is created. Add layers to your function with CreateFunction or UpdateFunctionConfiguration.",
            options: [
                {
                    name: "--layer-name",
                    description: "The name or Amazon Resource Name (ARN) of the layer.",
        ...
        },
        {
            ...
            description: "Creates a version from the current code and configuration of a function. Use versions to create a snapshot of your function code and configuration that doesn't change. AWS Lambda doesn't publish a version if the function's configuration and code haven't changed since the last version. Use UpdateFunctionCode or UpdateFunctionConfiguration to update the function before publishing a version. Clients can invoke versions directly or with an alias. To create an alias, use CreateAlias.",
            options: [
                {
                    name: "--function-name",
                    description: "The name of the Lambda function.  Name formats     Function name - MyFunction.    Function ARN - arn:aws:lambda:us-west-2:123456789012:function:MyFunction.    Partial ARN - 123456789012:function:MyFunction.   The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.",
        ...
        },
        {
            ...
            description: "Removes a statement from the permissions policy for a version of an AWS Lambda layer. For more information, see AddLayerVersionPermission.",
            options: [
                {
                    name: "--layer-name",
                    description: "The name or Amazon Resource Name (ARN) of the layer.",
        ...
        },
        {
            ...
            description: "Revokes function-use permission from an AWS service or another account. You can get the ID of the statement from the output of GetPolicy.",
            options: [
                {
                    name: "--function-name",
                    description: "The name of the Lambda function, version, or alias.  Name formats     Function name - my-function (name-only), my-function:v1 (with alias).    Function ARN - arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN - 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.",
        ...
        },
        {
            ...
            description: "Updates an event source mapping. You can change the function that AWS Lambda invokes, or pause invocation and resume later from the same location. The following error handling options are only available for stream sources (DynamoDB and Kinesis):    BisectBatchOnFunctionError - If the function returns an error, split the batch in two and retry.    DestinationConfig - Send discarded records to an Amazon SQS queue or Amazon SNS topic.    MaximumRecordAgeInSeconds - Discard records older than the specified age. The default value is infinite (-1). When set to infinite (-1), failed records are retried until the record expires    MaximumRetryAttempts - Discard records after the specified number of retries. The default value is infinite (-1). When set to infinite (-1), failed records are retried until the record expires.    ParallelizationFactor - Process multiple batches from each shard concurrently.",
            options: [
                {
                    name: "--uuid",
                    description: "The identifier of the event source mapping.",
            ...
            subcommands: [
                {
                    ...
                    description: "Waits for the function's State to be Active. It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks.",
                    options: [
                        {
                            name: "--function-name",
                            description: "The name of the Lambda function, version, or alias.  Name formats     Function name - my-function (name-only), my-function:v1 (with alias).    Function ARN - arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN - 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.",
                ...
                },
                {
                    ...
                    description: "Waits for the function's LastUpdateStatus to be Successful. It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks.",
                    options: [
                        {
                            name: "--function-name",
                            description: "The name of the Lambda function, version, or alias.  Name formats     Function name - my-function (name-only), my-function:v1 (with alias).    Function ARN - arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN - 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.",
