    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--name",
                    description: "The name of the environment to create. This name is visible to other AWS IAM users in the same AWS account.",
                    args: {
                        name: "string",
                    },
                },
                ...
                },
                {
                    ...
                    description: "A unique, case-sensitive string that helps AWS Cloud9 to ensure this operation completes no more than one time. For more information, see Client Tokens in the Amazon EC2 API Reference.",
                    args: {
                        name: "string",
                    },
                },
                ...
                },
                {
                    ...
                    description: "The connection type used for connecting to an Amazon EC2 environment. Valid values are CONNECT_SSH (default) and CONNECT_SSM (connected through AWS Systems Manager). For more information, see Accessing no-ingress EC2 instances with AWS Systems Manager in the AWS Cloud9 User Guide.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Gets a list of the tags associated with an AWS Cloud9 development environment.",
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) of the AWS Cloud9 development environment to get the tags for.",
                    args: {
                        name: "string",
                    },
                },
        ...
        {
            name: "tag-resource",
            description: "Adds tags to an AWS Cloud9 development environment.  Tags that you add to an AWS Cloud9 environment by using this method will NOT be automatically propagated to underlying resources.",
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) of the AWS Cloud9 development environment to add tags to.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--tags",
                    description: "The list of tags to add to the given AWS Cloud9 development environment.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) of the AWS Cloud9 development environment to remove tags from.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--tag-keys",
                    description: "The tag names of the tags to remove from the given AWS Cloud9 development environment.",
                    args: {
                        name: "list",
                    },
                },
