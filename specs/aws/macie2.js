    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--master-account",
                    description: "(Deprecated) The AWS account ID for the account that sent the invitation. This property has been replaced by the administratorAccountId property and is retained only for backward compatibility.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--name",
                    description: "A custom name for the filter. The name must contain at least 3 characters and can contain as many as 64 characters. We strongly recommend that you avoid including any sensitive data in the name of a filter. Other users of your account might be able to see the filter's name, depending on the actions that they're allowed to perform in Amazon Macie.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--account",
                    description: "The details for the account to associate with the administrator account.",
                    args: {
                        name: "structure",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--finding-types",
                    description: "An array that lists one or more types of findings to include in the set of sample findings. Currently, the only supported value is Policy:IAMUser/S3BucketEncryptionDisabled.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Retrieves (queries) statistical data and other information about one or more S3 buckets that Amazon Macie monitors and analyzes.",
            options: [
                {
                    name: "--criteria",
            ...
            options: [
                {
                    ...
                    description: "The AWS account ID of the delegated Amazon Macie administrator account.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Retrieves (queries) aggregated statistical data for all the S3 buckets that Amazon Macie monitors and analyzes.",
            options: [
                {
                    name: "--account-id",
        ...
        },
        {
            ...
            description: "Retrieves the configuration settings for publishing findings to AWS Security Hub.",
            options: [
                {
                    name: "--cli-input-json",
                    description: "Performs service operation based on the JSON string provided. The JSON string follows the format provided by ``--generate-cli-skeleton``. If other arguments are provided on the command line, the CLI values will override the JSON-provided values. It is not possible to pass arbitrary binary values using a JSON-provided value as the string will be taken literally.",
        ...
        },
        {
            ...
            description: "Updates the configuration settings for publishing findings to AWS Security Hub.",
            options: [
                {
                    name: "--client-token",
                    description: "A unique, case-sensitive token that you provide to ensure the idempotency of the request.",
                ...
                },
                {
                    ...
                    description: "The configuration settings that determine which findings to publish to AWS Security Hub.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--name",
                    description: "A custom name for the filter. The name must contain at least 3 characters and can contain as many as 64 characters. We strongly recommend that you avoid including any sensitive data in the name of a filter. Other users might be able to see the filter's name, depending on the actions that they're allowed to perform in Amazon Macie.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Enables an Amazon Macie administrator to suspend or re-enable a member account.",
            options: [
                {
                    name: "--id",
                    description: "The unique identifier for the Amazon Macie resource or account that the request applies to.",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--auto-enable",
                    description: "Specifies whether to enable Amazon Macie automatically for each account, when the account is added to the AWS organization.",
                },
                {
                    name: "--no-auto-enable",
                    description: "Specifies whether to enable Amazon Macie automatically for each account, when the account is added to the AWS organization.",
