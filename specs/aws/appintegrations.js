var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "The Amazon AppIntegrations APIs are in preview release and are subject to change. Deletes the specified existing event integration. If the event integration is associated with clients, the request is rejected.",
            options: [
                {
                    name: "--name",
                    description: "The name of the event integration.",
        ...
        },
        {
            ...
            description: "The Amazon AppIntegrations APIs are in preview release and are subject to change. Return information about the event integration.",
            options: [
                {
                    name: "--name",
                    description: "The name of the event integration.",
        ...
        },
        {
            ...
            description: "The Amazon AppIntegrations APIs are in preview release and are subject to change. Returns a paginated list of event integration associations in the account.",
            options: [
                {
        ...
        },
        {
            ...
            description: "The Amazon AppIntegrations APIs are in preview release and are subject to change. Returns a paginated list of event integrations in the account.",
            options: [
                {
                    name: "--next-token",
                    description: "The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.",
        ...
        },
        {
            ...
            description: "The Amazon AppIntegrations APIs are in preview release and are subject to change. Lists the tags for the specified resource.",
            options: [
                {
                    name: "--resource-arn",
        ...
        {
            name: "tag-resource",
            description: "The Amazon AppIntegrations APIs are in preview release and are subject to change. Adds the specified tags to the specified resource.",
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) of the resource.",
        ...
        {
            name: "untag-resource",
            description: "The Amazon AppIntegrations APIs are in preview release and are subject to change. Removes the specified tags from the specified resource.",
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) of the resource.",
        ...
        },
        {
            ...
            description: "The Amazon AppIntegrations APIs are in preview release and are subject to change. Updates the description of an event integration.",
            options: [
                {
                    name: "--name",
                    description: "The name of the event integration.",
