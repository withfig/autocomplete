    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The domain name for your origin. This argument and --distribution-config are mututally exclusive.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                },
                {
                    ...
                    description: "The object that you want CloudFront to return (for example, index.html) when a viewer request points to your root URL. This argument and --distribution-config are mututally exclusive.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--paths",
                    description: "The space-separated paths to be invalidated. Note: --invalidation-batch and --paths are mututally exclusive.",
                    args: {
                        name: "string",
                        variadic: true,
                    },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--type",
                    description: "A filter to return only the specified kinds of cache policies. Valid values are:    managed \u2013 Returns only the managed policies created by AWS.    custom \u2013 Returns only the custom policies created in your AWS account.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--type",
                    description: "A filter to return only the specified kinds of origin request policies. Valid values are:    managed \u2013 Returns only the managed policies created by AWS.    custom \u2013 Returns only the custom policies created in your AWS account.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--default-root-object",
                    description: "The object that you want CloudFront to return (for example, index.html) when a viewer request points to your root URL. CLI will automatically make a get-distribution-config call to load and preserve your other settings. This argument and --distribution-config are mututally exclusive.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
