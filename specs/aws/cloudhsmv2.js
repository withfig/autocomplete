var completionSpec = {
    ...
    subcommands: [
        ...
        {
            name: "delete-backup",
            description: "Deletes a specified AWS CloudHSM backup. A backup can be restored up to 7 days after the DeleteBackup request is made. For more information on restoring a backup, see RestoreBackup.",
            options: [
                {
                    name: "--backup-id",
        ...
        {
            name: "delete-cluster",
            description: "Deletes the specified AWS CloudHSM cluster. Before you can delete a cluster, you must delete all HSMs in the cluster. To see if the cluster contains any HSMs, use DescribeClusters. To delete an HSM, use DeleteHsm.",
            options: [
                {
                    name: "--cluster-id",
        ...
        {
            name: "delete-hsm",
            description: "Deletes the specified HSM. To specify an HSM, you can use its identifier (ID), the IP address of the HSM's elastic network interface (ENI), or the ID of the HSM's ENI. You need to specify only one of these values. To find these values, use DescribeClusters.",
            options: [
                {
                    name: "--cluster-id",
        ...
        {
            name: "restore-backup",
            description: "Restores a specified AWS CloudHSM backup that is in the PENDING_DELETION state. For mor information on deleting a backup, see DeleteBackup.",
            options: [
                {
                    name: "--backup-id",
