var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Gets the properties associated with an asycnhronous batch translation job including name, ID, status, source and target languages, input/output S3 buckets, and so on.",
            options: [
                {
                    name: "--job-id",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Specifies the format and S3 location of the input documents for the translation job.",
                    args: {
                        name: "structure",
                    },
                },
                ...
                },
                {
                    ...
                    description: "The Amazon Resource Name (ARN) of an AWS Identity Access and Management (IAM) role that grants Amazon Translate read access to your input data. For more nformation, see identity-and-access-management.",
                    args: {
                        name: "string",
                    },
                },
                {
                    ...
                    description: "The language code of the input language. For a list of language codes, see what-is-languages. Amazon Translate does not automatically detect a source language during batch translation jobs.",
                    args: {
                        name: "string",
                    },
                },
                ...
                },
                {
                    ...
                    description: "The name of the terminology to use in the batch translation job. For a list of available terminologies, use the ListTerminologies operation.",
                    args: {
                        name: "list",
                    },
                },
                {
                    ...
                    description: "The names of the parallel data resources to use in the batch translation job. For a list of available parallel data resources, use the ListParallelData operation.",
                    args: {
                        name: "list",
                    },
                },
                {
                    name: "--client-token",
                    description: "A unique identifier for the request. This token is auto-generated when using the Amazon Translate SDK.",
                    args: {
                        name: "string",
                    },
                },
        ...
        {
            name: "translate-text",
            description: "Translates input text from the source language to the target language. For a list of available languages and language codes, see what-is-languages.",
            options: [
                {
                    name: "--text",
