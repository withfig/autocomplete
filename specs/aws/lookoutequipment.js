    ...
    subcommands: [
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Provides the identifier of the AWS KMS customer master key (CMK) used to encrypt dataset data by Amazon Lookout for Equipment.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--server-side-kms-key-id",
                    description: "Provides the identifier of the AWS KMS customer master key (CMK) used to encrypt model data by Amazon Lookout for Equipment.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Provides information on a specific data ingestion job such as creation time, dataset ARN, status, and so on.",
            options: [
                {
                    name: "--job-id",
        ...
        },
        {
            ...
            description: "Provides information on a specified dataset such as the schema location, status, and so on.",
            options: [
                {
                    name: "--dataset-name",
        ...
        {
            name: "describe-model",
            description: "Provides overall information about a specific ML model, including model name and ARN, dataset, training and evaluation information, status, and so on.",
            options: [
                {
                    name: "--model-name",
