    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-arn-list",
                    description: "Specifies the list of ARNs of the resources that you want to apply tags to. An ARN (Amazon Resource Name) uniquely identifies a resource. For more information, see Amazon Resource Names (ARNs) and AWS Service Namespaces in the AWS General Reference.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-arn-list",
                    description: "Specifies a list of ARNs of the resources that you want to remove tags from. An ARN (Amazon Resource Name) uniquely identifies a resource. For more information, see Amazon Resource Names (ARNs) and AWS Service Namespaces in the AWS General Reference.",
                    args: {
                        name: "list",
                    },
                },
