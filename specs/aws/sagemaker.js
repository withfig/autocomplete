    ...
    subcommands: [
        {
            ...
            description: "Creates an association between the source and the destination. A source can be associated with multiple destinations, and a destination can be associated with multiple sources. An association is a lineage tracking entity. For more information, see Amazon SageMaker ML Lineage Tracking.",
            options: [
                {
                    name: "--source-arn",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "An array of key-value pairs. You can use tags to categorize your AWS resources in different ways, for example, by purpose, owner, or environment. For more information, see Tagging AWS Resources.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Associates a trial component with a trial. A trial component can be associated with multiple trials. To disassociate a trial component from a trial, call the DisassociateTrialComponent API.",
            options: [
                {
        ...
        {
            name: "create-action",
            description: "Creates an action. An action is a lineage tracking entity that represents an action or activity. For example, a model deployment or an HPO job. Generally, an action involves at least one input or output artifact. For more information, see Amazon SageMaker ML Lineage Tracking.",
            options: [
                {
                    name: "--action-name",
        ...
        },
        {
            ...
            description: "Creates an artifact. An artifact is a lineage tracking entity that represents a URI addressable object or data. Some examples are the S3 URI of a dataset and the ECR registry path of an image. For more information, see Amazon SageMaker ML Lineage Tracking.",
            options: [
                {
                    name: "--artifact-name",
        ...
        },
        {
            ...
            description: "Creates an Autopilot job. Find the best performing model after you run an Autopilot job by calling . For information about how to use Autopilot, see Automate Model Development with Amazon SageMaker Autopilot.",
            options: [
                {
                ...
                },
                {
                    ...
                    description: "An array of channel objects that describes the input data and its location. Each channel is a named input source. Similar to InputDataConfig supported by . Format(s) supported: CSV. Minimum of 500 rows.",
                    args: {
                        name: "list",
                    },
                },
                ...
                {
                    name: "--problem-type",
                    description: "Defines the type of supervised learning available for the candidates. Options include: BinaryClassification, MulticlassClassification, and Regression. For more information, see  Amazon SageMaker Autopilot problem types and algorithm support.",
                    args: {
                        name: "string",
                    },
                },
                {
                    ...
                    description: "Defines the objective metric used to measure the predictive quality of an AutoML job. You provide a AutoMLJobObjective$MetricName and Autopilot infers whether to minimize or maximize it.",
                    args: {
                        name: "structure",
                    },
                },
                {
                    ...
                    description: "Contains CompletionCriteria and SecurityConfig settings for the AutoML job.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--role-arn",
                    description: "The Amazon Resource Name (ARN) of an IAM role that enables Amazon SageMaker to perform tasks on your behalf.  During model compilation, Amazon SageMaker needs your permission to:   Read input data from an S3 bucket   Write model artifacts to an S3 bucket   Write logs to Amazon CloudWatch Logs   Publish metrics to Amazon CloudWatch   You grant permissions for all of these tasks to an IAM role. To pass this role to Amazon SageMaker, the caller of this API must have the iam:PassRole permission. For more information, see Amazon SageMaker Roles.",
                    args: {
                        name: "string",
                    },
                },
        ...
        {
            name: "create-context",
            description: "Creates a context. A context is a lineage tracking entity that represents a logical grouping of other tracking or experiment entities. Some examples are an endpoint and a model package. For more information, see Amazon SageMaker ML Lineage Tracking.",
            options: [
                {
                    name: "--context-name",
        ...
        },
        {
            ...
            description: "Creates a definition for a job that monitors data quality and drift. For information about model monitor, see Amazon SageMaker Model Monitor.",
            options: [
                {
                ...
                {
                    name: "--tags",
                    description: "(Optional) An array of key-value pairs. For more information, see Using Cost Allocation Tags in the AWS Billing and Cost Management User Guide.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--endpoint-name",
                    description: "The name of the endpoint.The name must be unique within an AWS Region in your AWS account. The name is case-insensitive in CreateEndpoint, but the case is preserved and must be matched in .",
                    args: {
                        name: "string",
                    },
                },
            ...
            options: [
                {
                    ...
                    description: "The name of the FeatureGroup. The name must be unique within an AWS Region in an AWS account. The name:   Must start and end with an alphanumeric character.   Can only contain alphanumeric character and hyphens. Spaces are not allowed.",
                    args: {
                        name: "string",
                    },
                },
                ...
                },
                {
                    ...
                    description: "You can turn the OnlineStore on or off by specifying True for the EnableOnlineStore flag in OnlineStoreConfig; the default value is False. You can also include an AWS KMS key ID (KMSKeyId) for at-rest encryption of the OnlineStore.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "An array of key-value pairs. You can use tags to categorize your AWS resources in different ways, for example, by purpose, owner, or environment. For more information, see Tagging AWS Resources. Tags that you specify for the tuning job are also added to all training jobs that the tuning job launches.",
                    args: {
                        name: "list",
                    },
                },
        ...
        {
            name: "create-image",
            description: "Creates a custom SageMaker image. A SageMaker image is a set of image versions. Each image version represents a container image stored in Amazon Container Registry (ECR). For more information, see Bring your own SageMaker image.",
            options: [
                {
                    name: "--description",
        ...
        },
        {
            ...
            description: "Creates a version of the SageMaker image specified by ImageName. The version represents the Amazon Container Registry (ECR) container image specified by BaseImage.",
            options: [
                {
                    name: "--base-image",
                    description: "The registry path of the container image to use as the starting point for this version. The path is an Amazon Container Registry (ECR) URI in the following format:  &lt;acct-id&gt;.dkr.ecr.&lt;region&gt;.amazonaws.com/&lt;repo-name[:tag] or [@digest]&gt;",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--client-token",
                    description: "A unique ID. If not specified, the AWS CLI and AWS SDKs, such as the SDK for Python (Boto3), add a unique value to the call.",
                    args: {
                        name: "string",
                    },
                },
            ...
            options: [
                {
                    ...
                    description: "The name of the labeling job. This name is used to identify the job in a list of labeling jobs. Labeling job names must be unique within an AWS account and region. LabelingJobName is not case sensitive. For example, Example-job and example-job are considered the same labeling job name by Ground Truth.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The name of the model group that this model version belongs to. This parameter is required for versioned models, and does not apply to unversioned models.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--certify-for-marketplace",
                    description: "Whether to certify the model package for listing on AWS Marketplace. This parameter is optional for unversioned models, and does not apply to versioned models.",
                },
                {
                    name: "--no-certify-for-marketplace",
                    description: "Whether to certify the model package for listing on AWS Marketplace. This parameter is optional for unversioned models, and does not apply to versioned models.",
                ...
                {
                    name: "--tags",
                    description: "A list of key value pairs associated with the model. For more information, see Tagging AWS resources in the AWS General Reference Guide.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "A list of key value pairs associated with the model group. For more information, see Tagging AWS resources in the AWS General Reference Guide.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Creates a definition for a job that monitors model quality and drift. For information about model monitor, see Amazon SageMaker Model Monitor.",
            options: [
                {
                    name: "--job-definition-name",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "An array of key-value pairs that you want to use to organize and track your AWS resource costs. For more information, see Tagging AWS resources in the AWS General Reference Guide.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--stopping-condition",
                    description: "Specifies a limit to how long a model training job can run. When the job reaches the time limit, Amazon SageMaker ends the training job. Use this API to cap model training costs. To stop a job, Amazon SageMaker sends the algorithm the SIGTERM signal, which delays job termination for 120 seconds. Algorithms can use this 120-second window to save the model artifacts, so the results of training are not lost.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--model-name",
                    description: "The name of the model that you want to use for the transform job. ModelName must be the name of an existing Amazon SageMaker model within an AWS Region in an AWS account.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--status",
                    description: "The status of the component. States include:   InProgress   Completed   Failed",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--cognito-config",
                    description: "Use this parameter to configure an Amazon Cognito private workforce. A single Cognito workforce is created using and corresponds to a single  Amazon Cognito user pool. Do not use OidcConfig if you specify values for CognitoConfig.",
                    args: {
                        name: "structure",
                    },
                },
                {
                    name: "--oidc-config",
                    description: "Use this parameter to configure a private workforce using your own OIDC Identity Provider. Do not use CognitoConfig if you specify values for OidcConfig.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            description: "Creates a new work team for labeling your data. A work team is defined by one or more Amazon Cognito user pools. You must first create the user pools before you can create a work team. You cannot create more than 25 work teams in an account and region.",
            options: [
                {
                    name: "--workteam-name",
                ...
                {
                    name: "--tags",
                    description: "An array of key-value pairs. For more information, see Resource Tag and Using Cost Allocation Tags in the  AWS Billing and Cost Management User Guide.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Deletes an artifact. Either ArtifactArn or Source must be specified.",
            options: [
                {
                    name: "--artifact-arn",
        ...
        },
        {
            ...
            description: "Deletes an endpoint. Amazon SageMaker frees up all of the resources that were deployed when the endpoint was created.  Amazon SageMaker retires any custom KMS key grants associated with the endpoint, meaning you don't need to use the RevokeGrant API call.",
            options: [
                {
                    name: "--endpoint-name",
        ...
        },
        {
            ...
            description: "Deletes an endpoint configuration. The DeleteEndpointConfig API deletes only the specified configuration. It does not delete endpoints created using the configuration.  You must not delete an EndpointConfig in use by an endpoint that is live or while the UpdateEndpoint or CreateEndpoint operations are being performed on the endpoint. If you delete the EndpointConfig of an endpoint that is active or being created or updated you may lose visibility into the instance type the endpoint is using. The endpoint must be deleted in order to stop incurring charges.",
            options: [
                {
                    name: "--endpoint-config-name",
        ...
        },
        {
            ...
            description: "Deletes an Amazon SageMaker experiment. All trials associated with the experiment must be deleted first. Use the ListTrials API to get a list of the trials associated with the experiment.",
            options: [
                {
                    name: "--experiment-name",
        ...
        },
        {
            ...
            description: "Use this operation to delete a human task user interface (worker task template).  To see a list of human task user interfaces (work task templates) in your account, use . When you delete a worker task template, it no longer appears when you call ListHumanTaskUis.",
            options: [
                {
                    name: "--human-task-ui-name",
        ...
        {
            name: "delete-model",
            description: "Deletes a model. The DeleteModel API deletes only the model entry that was created in Amazon SageMaker when you called the CreateModel API. It does not delete model artifacts, inference code, or the IAM role that you specified when creating the model.",
            options: [
                {
                    name: "--model-name",
        ...
        },
        {
            ...
            description: "Deletes a model package. A model package is used to create Amazon SageMaker models or list on AWS Marketplace. Buyers can subscribe to model packages listed on AWS Marketplace to create models in Amazon SageMaker.",
            options: [
                {
                    name: "--model-package-name",
        ...
        {
            name: "delete-tags",
            description: "Deletes the specified tags from an Amazon SageMaker resource. To list a resource's tags, use the ListTags API.   When you call this API to delete tags from a hyperparameter tuning job, the deleted tags are not removed from training jobs that the hyperparameter tuning job launched before you called this API.",
            options: [
                {
                    name: "--resource-arn",
        ...
        {
            name: "delete-trial",
            description: "Deletes the specified trial. All trial components that make up the trial must be deleted first. Use the DescribeTrialComponent API to get the list of trial components.",
            options: [
                {
                    name: "--trial-name",
        ...
        },
        {
            ...
            description: "Deletes the specified trial component. A trial component must be disassociated from all trials before the trial component can be deleted. To disassociate a trial component from a trial, call the DisassociateTrialComponent API.",
            options: [
                {
                    name: "--trial-component-name",
        ...
        },
        {
            ...
            description: "Returns information about a model compilation job. To create a model compilation job, use CreateCompilationJob. To get information about multiple model compilation jobs, use ListCompilationJobs.",
            options: [
                {
                    name: "--compilation-job-name",
        ...
        },
        {
            ...
            description: "Use this operation to describe a FeatureGroup. The response includes information on the creation time, FeatureGroup name, the unique identifier for each FeatureGroup, and more.",
            options: [
                {
                    name: "--feature-group-name",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--job-definition-name",
                    description: "The name of the model bias job definition. The name must be unique within an AWS Region in the AWS account.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns a description of the specified model package, which is used to create Amazon SageMaker models or list them on AWS Marketplace. To create models in Amazon SageMaker, buyers can subscribe to model packages listed on AWS Marketplace.",
            options: [
                {
                    name: "--model-package-name",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--job-definition-name",
                    description: "The name of the model quality job. The name must be unique within an AWS Region in the AWS account.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns a description of a notebook instance lifecycle configuration. For information about notebook instance lifestyle configurations, see Step 2.1: (Optional) Customize a Notebook Instance.",
            options: [
                {
                    name: "--notebook-instance-lifecycle-config-name",
        ...
        },
        {
            ...
            description: "Describes a user profile. For more information, see CreateUserProfile.",
            options: [
                {
                    name: "--domain-id",
                    description: "The domain ID.",
        ...
        },
        {
            ...
            description: "Lists private workforce information, including workforce name, Amazon Resource Name (ARN), and, if applicable, allowed IP address ranges (CIDRs). Allowable IP address ranges are the IP addresses that workers can use to access tasks.   This operation applies only to private workforces.",
            options: [
                {
                    name: "--workforce-name",
        ...
        },
        {
            ...
            description: "Gets a resource policy that manages access for a model group. For information about resource policies, see Identity-based policies and resource-based policies in the AWS Identity and Access Management User Guide..",
            options: [
                {
                    name: "--model-package-group-name",
        ...
        },
        {
            ...
            description: "An auto-complete API for the search functionality in the Amazon SageMaker console. It returns suggestions of possible matches for the property name to use in Search queries. Provides suggestions for HyperParameters, Tags, and Metrics.",
            options: [
                {
                    name: "--resource",
        ...
        },
        {
            ...
            description: "Lists model compilation jobs that satisfy various filters. To create a model compilation job, use CreateCompilationJob. To get information about a particular model compilation job you have created, use DescribeCompilationJob.",
            options: [
                {
                    name: "--next-token",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--name-contains",
                    description: "A string that partially matches one or more FeatureGroups names. Filters FeatureGroups by name.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--creation-time-after",
                    description: "Use this parameter to search for FeatureGroupss created after a specific date and time.",
                    args: {
                        name: "timestamp",
                    },
                },
                {
                    name: "--creation-time-before",
                    description: "Use this parameter to search for FeatureGroupss created before a specific date and time.",
                    args: {
                        name: "timestamp",
                    },
                },
        ...
        },
        {
            ...
            description: "Gets a list of HyperParameterTuningJobSummary objects that describe the hyperparameter tuning jobs launched in your account.",
            options: [
                {
                    name: "--next-token",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "A filter that returns onlyl the model packages of the specified type. This can be one of the following values.    VERSIONED - List only versioned models.    UNVERSIONED - List only unversioined models.    BOTH - List both versioned and unversioned models.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Lists notebook instance lifestyle configurations created with the CreateNotebookInstanceLifecycleConfig API.",
            options: [
                {
                    name: "--next-token",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--next-token",
                    description: "If the previous call to the ListNotebookInstances is truncated, the response includes a NextToken. You can use this token in your subsequent ListNotebookInstances request to fetch the next set of notebook instances.   You might specify a filter or a sort order in your request. When response is truncated, you must use the same values for the filer and sort order in the next request.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Gets a list of the work teams that you are subscribed to in the AWS Marketplace. The list may be empty if no work team satisfies the filter specified in the NameContains parameter.",
            options: [
                {
                    name: "--name-contains",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--next-token",
                    description: "If the response to the previous ListTags request is truncated, Amazon SageMaker returns this token. To retrieve the next set of tags, use it in the subsequent request.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Gets a list of TrainingJobSummary objects that describe the training jobs that a hyperparameter tuning job launched.",
            options: [
                {
                    name: "--hyper-parameter-tuning-job-name",
                ...
                {
                    name: "--sort-by",
                    description: "The field to sort results by. The default is Name. If the value of this field is FinalObjectiveMetricValue, any training jobs that did not return an objective metric are not listed.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Lists the trial components in your account. You can sort the list by trial component name or creation time. You can filter the list to show only components that were created in a specific time range. You can also filter on one of the following:    ExperimentName     SourceArn     TrialName",
            options: [
                {
                    name: "--experiment-name",
        ...
        },
        {
            ...
            description: "Use this operation to list all private and vendor workforces in an AWS Region. Note that you can only have one private workforce per AWS Region.",
            options: [
                {
                    name: "--sort-by",
        ...
        {
            name: "list-workteams",
            description: "Gets a list of private work teams that you have defined in a region. The list may be empty if no work team satisfies the filter specified in the NameContains parameter.",
            options: [
                {
                    name: "--sort-by",
                    description: "The field to sort results by. The default is CreationTime.",
        ...
        },
        {
            ...
            description: "Adds a resouce policy to control access to a model group. For information about resoure policies, see Identity-based policies and resource-based policies in the AWS Identity and Access Management User Guide..",
            options: [
                {
                    name: "--model-package-group-name",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The HumanTaskUiArn of the worker UI that you want to render. Do not provide a HumanTaskUiArn if you use the UiTemplate parameter. See a list of available Human Ui Amazon Resource Names (ARNs) in UiConfig.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Starts a previously stopped monitoring schedule.  By default, when you successfully create a new schedule, the status of a monitoring schedule is scheduled.",
            options: [
                {
                    name: "--monitoring-schedule-name",
        ...
        },
        {
            ...
            description: "Stops a running hyperparameter tuning job and all running training jobs that the tuning job launched. All model artifacts output from the training jobs are stored in Amazon Simple Storage Service (Amazon S3). All data that the training jobs write to Amazon CloudWatch Logs are still available in CloudWatch. After the tuning job moves to the Stopped state, it releases all reserved resources for the tuning job.",
            options: [
                {
                    name: "--hyper-parameter-tuning-job-name",
        ...
        },
        {
            ...
            description: "Terminates the ML compute instance. Before terminating the instance, Amazon SageMaker disconnects the ML storage volume from it. Amazon SageMaker preserves the ML storage volume. Amazon SageMaker stops charging you for the ML compute instance when you call StopNotebookInstance. To access data on the ML storage volume for a notebook instance that has been terminated, call the StartNotebookInstance API. StartNotebookInstance launches another ML compute instance, configures it, and attaches the preserved ML storage volume so you can continue your work.",
            options: [
                {
                    name: "--notebook-instance-name",
        ...
        {
            name: "update-image",
            description: "Updates the properties of a SageMaker image. To change the image's tags, use the AddTags and DeleteTags APIs.",
            options: [
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--role-arn",
                    description: "The Amazon Resource Name (ARN) of the IAM role that Amazon SageMaker can assume to access the notebook instance. For more information, see Amazon SageMaker Roles.   To be able to pass this role to Amazon SageMaker, the caller of this API must have the iam:PassRole permission.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--root-access",
                    description: "Whether root access is enabled or disabled for users of the notebook instance. The default value is Enabled.  If you set this to Disabled, users don't have root access on the notebook instance, but lifecycle configuration scripts still run with root permissions.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--source-ip-config",
                    description: "A list of one to ten worker IP address ranges (CIDRs) that can be used to access tasks assigned to this workforce. Maximum: Ten CIDR values",
                    args: {
                        name: "structure",
                    },
                },
            ...
            subcommands: [
                {
                    ...
                    description: "Wait until ValidationException is thrown when polling with ``describe-endpoint``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks.",
                    options: [
                        {
                            name: "--endpoint-name",
                            description: "The name of the endpoint.",
                ...
                },
                {
                    ...
                    description: "Wait until JMESPath query EndpointStatus returns InService when polling with ``describe-endpoint``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 120 failed checks.",
                    options: [
                        {
                            name: "--endpoint-name",
                            description: "The name of the endpoint.",
                ...
                },
                {
                    ...
                    description: "Wait until ValidationException is thrown when polling with ``describe-notebook-instance``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks.",
                    options: [
                        {
                            name: "--notebook-instance-name",
                            description: "The name of the notebook instance that you want information about.",
                ...
                },
                {
                    ...
                    description: "Wait until JMESPath query NotebookInstanceStatus returns InService when polling with ``describe-notebook-instance``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks.",
                    options: [
                        {
                            name: "--notebook-instance-name",
                            description: "The name of the notebook instance that you want information about.",
                ...
                },
                {
                    ...
                    description: "Wait until JMESPath query NotebookInstanceStatus returns Stopped when polling with ``describe-notebook-instance``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks.",
                    options: [
                        {
                            name: "--notebook-instance-name",
                            description: "The name of the notebook instance that you want information about.",
                ...
                },
                {
                    ...
                    description: "Wait until JMESPath query ProcessingJobStatus returns Completed when polling with ``describe-processing-job``. It will poll every 60 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks.",
                    options: [
                        {
                            name: "--processing-job-name",
                            description: "The name of the processing job. The name must be unique within an AWS Region in the AWS account.",
                ...
                },
                {
                    ...
                    description: "Wait until JMESPath query TrainingJobStatus returns Completed when polling with ``describe-training-job``. It will poll every 120 seconds until a successful state has been reached. This will exit with a return code of 255 after 180 failed checks.",
                    options: [
                        {
                            name: "--training-job-name",
                            description: "The name of the training job.",
                ...
                },
                {
                    ...
                    description: "Wait until JMESPath query TransformJobStatus returns Completed when polling with ``describe-transform-job``. It will poll every 60 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks.",
                    options: [
                        {
                            name: "--transform-job-name",
                            description: "The name of the transform job that you want to view details of.",
