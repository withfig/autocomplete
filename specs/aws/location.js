    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--consumer-arn",
                    description: "The Amazon Resource Name (ARN) for the geofence collection to be associated to tracker resource. Used when you need to specify a resource across all AWS.    Format example: arn:partition:service:region:account-id:resource-type:resource-id",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Deletes a batch of geofences from a geofence collection.  This action deletes the resource permanently. You can't undo this action.",
            options: [
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--pricing-plan",
                    description: "Specifies the pricing plan for your geofence collection. For additional details and restrictions on each pricing plan option, see the Amazon Location Service pricing page.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--pricing-plan",
                    description: "Specifies the pricing plan for your map resource. For additional details and restrictions on each pricing plan option, see the Amazon Location Service pricing page.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--data-source",
                    description: "Specifies the data provider of geospatial data.  This field is case-sensitive. Enter the valid values as shown. For example, entering HERE will return an error.  Valid values include:    Esri     Here    For additional details on data providers, see the Amazon Location Service data providers page.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--pricing-plan",
                    description: "Specifies the pricing plan for your Place index resource. For additional details and restrictions on each pricing plan option, see the Amazon Location Service pricing page.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--pricing-plan",
                    description: "Specifies the pricing plan for your tracker resource. For additional details and restrictions on each pricing plan option, see the Amazon Location Service pricing page.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Deletes a geofence collection from your AWS account.  This action deletes the resource permanently. You can't undo this action. If the geofence collection is the target of a tracker resource, the devices will no longer be monitored.",
            options: [
                {
                    name: "--collection-name",
        ...
        {
            name: "delete-map",
            description: "Deletes a map resource from your AWS account.  This action deletes the resource permanently. You cannot undo this action. If the map is being used in an application, the map may not render.",
            options: [
                {
                    name: "--map-name",
        ...
        },
        {
            ...
            description: "Deletes a Place index resource from your AWS account.  This action deletes the resource permanently. You cannot undo this action.",
            options: [
                {
                    name: "--index-name",
        ...
        {
            name: "delete-tracker",
            description: "Deletes a tracker resource from your AWS account.  This action deletes the resource permanently. You can't undo this action. If the tracker resource is in use, you may encounter an error. Make sure that the target resource is not a dependency for your applications.",
            options: [
                {
                    name: "--tracker-name",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--consumer-arn",
                    description: "The Amazon Resource Name (ARN) for the geofence collection to be disassociated from the tracker resource. Used when you need to specify a resource across all AWS.    Format example: arn:partition:service:region:account-id:resource-type:resource-id",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Retrieves a device's most recent position according to its sample time.  Device positions are deleted after one year.",
            options: [
                {
                    name: "--device-id",
        ...
        },
        {
            ...
            description: "Retrieves the device position history from a tracker resource within a specified range of time.  Device positions are deleted after 1 year.",
            options: [
                {
                    name: "--device-id",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--font-stack",
                    description: "A comma-separated list of fonts to load glyphs from in order of preference.. For example, Noto Sans, Arial Unicode.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--file-name",
                    description: "The name of the sprite \ufb01le. Use the following \ufb01le names for the sprite sheet:    sprites.png     sprites@2x.png for high pixel density displays   For the JSON document contain image offsets. Use the following \ufb01le names:    sprites.json     sprites@2x.json for high pixel density displays",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--geometry",
                    description: "Contains the polygon details to specify the position of the geofence.  Each geofence polygon can have a maximum of 1,000 vertices.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "An optional paramer. The maximum number of results returned per request.  Default value: 50",
                    args: {
                        name: "integer",
                    },
                },
                {
                    name: "--position",
                    description: "Specifies a coordinate for the query defined by a longitude, and latitude.   The first position is the X coordinate, or longitude.   The second position is the Y coordinate, or latitude.    For example, position=xLongitude&amp;position=yLatitude .",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Limits the search to the given a list of countries/regions. An optional parameter.   Use the ISO 3166 3-digit country code. For example, Australia uses three upper-case characters: AUS.",
                    args: {
                        name: "list",
                    },
                },
