var completionSpec = {
    ...
    subcommands: [
        {
            name: "put-events",
            description: "Records user interaction event data. For more information see Recording Events.",
            options: [
                {
                    name: "--tracking-id",
                ...
                {
                    name: "--session-id",
                    description: "The session ID associated with the user's visit. Your application generates the sessionId when a user first visits your website or uses your application. Amazon Personalize uses the sessionId to associate events with the user before they log in. For more information, see Recording Events.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        {
            name: "put-items",
            description: "Adds one or more items to an Items dataset. For more information see Importing Items Incrementally.",
            options: [
                {
                    name: "--dataset-arn",
        ...
        {
            name: "put-users",
            description: "Adds one or more users to a Users dataset. For more information see Importing Users Incrementally.",
            options: [
                {
                    name: "--dataset-arn",
