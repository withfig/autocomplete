    ...
    subcommands: [
        ...
        },
        {
            ...
            subcommands: [
                {
                    name: "fleet-started",
                    description: "Wait until JMESPath query Fleets[].State returns ACTIVE for all elements when polling with ``describe-fleets``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 40 failed checks.",
                    options: [
                        {
                            name: "--names",
                            description: "The names of the fleets to describe.",
                ...
                {
                    name: "fleet-stopped",
                    description: "Wait until JMESPath query Fleets[].State returns INACTIVE for all elements when polling with ``describe-fleets``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 40 failed checks.",
                    options: [
                        {
                            name: "--names",
                            description: "The names of the fleets to describe.",
