    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--resource-name",
                    description: "The Amazon Resource Name (ARN) of the resource to which the tags are to be added, for example arn:aws:elasticache:us-west-2:0123456789:cluster:myCluster or arn:aws:elasticache:us-west-2:0123456789:snapshot:mySnapshot. ElastiCache resources are cluster and snapshot. For more information about ARNs, see Amazon Resource Names (ARNs) and AWS Service Namespaces.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Creates a cluster. All nodes in the cluster run the same protocol-compliant cache engine software, either Memcached or Redis. This operation is not supported for Redis (cluster mode enabled) clusters.",
            options: [
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--user-group-ids",
                    description: "The list of user groups to associate with the replication group.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Creates a copy of an entire cluster or replication group at a specific moment in time.  This operation is valid for Redis only.",
            options: [
                {
                    name: "--replication-group-id",
        ...
        {
            name: "create-user",
            description: "For Redis engine version 6.x onwards: Creates a Redis user. For more information, see Using Role Based Access Control (RBAC).",
            options: [
                {
                    name: "--user-id",
        ...
        },
        {
            ...
            description: "For Redis engine version 6.x onwards: Creates a Redis user group. For more information, see Using Role Based Access Control (RBAC)",
            options: [
                {
                    name: "--user-group-id",
        ...
        },
        {
            ...
            description: "Deletes an existing snapshot. When you receive a successful response from this operation, ElastiCache immediately begins deleting the snapshot; you cannot cancel or revert this operation.  This operation is valid for Redis only.",
            options: [
                {
                    name: "--snapshot-name",
        ...
        {
            name: "delete-user",
            description: "For Redis engine version 6.x onwards: Deletes a user. The user will be removed from all user groups and in turn removed from all replication groups. For more information, see Using Role Based Access Control (RBAC).",
            options: [
                {
                    name: "--user-id",
                    description: "The ID of the user.",
        ...
        },
        {
            ...
            description: "For Redis engine version 6.x onwards: Deletes a user group. The user group must first be disassociated from the replication group before it can be deleted. For more information, see Using Role Based Access Control (RBAC).",
            options: [
                {
                    name: "--user-group-id",
                    description: "The ID of the user group.",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--cache-parameter-group-family",
                    description: "The name of the cache parameter group family. Valid values are: memcached1.4 | memcached1.5 | memcached1.6 | redis2.6 | redis2.8 | redis3.2 | redis4.0 | redis5.0 | redis6.x |",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Returns information about a particular replication group. If no identifier is specified, DescribeReplicationGroups returns information about all replication groups.  This operation is valid for Redis only.",
            options: [
                {
                    name: "--replication-group-id",
        ...
        },
        {
            ...
            description: "Returns information about cluster or replication group snapshots. By default, DescribeSnapshots lists all of your snapshots; it can optionally describe a single snapshot, or just the snapshots associated with a particular cache cluster.  This operation is valid for Redis only.",
            options: [
                {
                    name: "--replication-group-id",
        ...
        },
        {
            ...
            description: "Remove a secondary cluster from the Global datastore using the Global datastore name. The secondary cluster will no longer receive updates from the primary cluster, but will remain as a standalone cluster in that AWS region.",
            options: [
                {
                    name: "--global-replication-group-id",
                    description: "The name of the Global datastore",
                ...
                },
                {
                    ...
                    description: "The AWS region of secondary cluster you wish to remove from the Global datastore",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--primary-region",
                    description: "The AWS region of the primary cluster of the Global datastore",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Lists all available node types that you can scale your Redis cluster's or replication group's current node type. When you use the ModifyCacheCluster or ModifyReplicationGroup operations to scale your cluster or replication group, the value of the CacheNodeType parameter must be one of the node types returned by this operation.",
            options: [
                {
                    name: "--cache-cluster-id",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Specifies the strategy to use to update the AUTH token. This parameter must be specified with the auth-token parameter. Possible values:   Rotate   Set    For more information, see Authenticating Users with Redis AUTH",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Modifies the settings for a replication group.    Scaling for Amazon ElastiCache for Redis (cluster mode enabled) in the ElastiCache User Guide    ModifyReplicationGroupShardConfiguration in the ElastiCache API Reference    This operation is valid for Redis only.",
            options: [
                {
                    name: "--replication-group-id",
                ...
                },
                {
                    ...
                    description: "A list of users groups to remove, meaning the users in the group no longer can access thereplication group.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Allows you to purchase a reserved cache node offering. Reserved nodes are not eligible for cancellation and are non-refundable. For more information, see Managing Costs with Reserved Nodes for Redis or Managing Costs with Reserved Nodes for Memcached.",
            options: [
                {
                    name: "--reserved-cache-nodes-offering-id",
