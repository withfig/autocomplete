    ...
    subcommands: [
        {
            ...
            description: "Adds an instance fleet to a running cluster.  The instance fleet configuration is available only in Amazon EMR versions 4.8.0 and later, excluding 5.0.x.",
            options: [
                {
                    name: "--cluster-id",
        ...
        {
            name: "add-tags",
            description: "Adds tags to an Amazon EMR resource. Tags make it easier to associate clusters in various ways, such as grouping clusters to track your Amazon EMR resource allocation costs. For more information, see Tag Clusters.",
            options: [
                {
                    name: "--resource-id",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--identity-id",
                    description: "The globally unique identifier (GUID) of the user or group from the AWS SSO Identity Store. For more information, see UserId and GroupId in the AWS SSO Identity Store API Reference. Either IdentityName or IdentityId must be specified.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--identity-id",
                    description: "The globally unique identifier (GUID) of the user or group to remove from the Amazon EMR Studio. For more information, see UserId and GroupId in the AWS SSO Identity Store API Reference. Either IdentityName or IdentityId must be specified.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--identity-name",
                    description: "The name of the user name or group to remove from the Amazon EMR Studio. For more information, see UserName and DisplayName in the AWS SSO Identity Store API Reference. Either IdentityName or IdentityId must be specified.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Provides  cluster-level details including status, hardware and software configuration, VPC settings, bootstrap actions, instance groups and so on. For information about the cluster steps, see <code>list-steps</code>.",
            options: [
                {
                    name: "--cluster-id",
                    description: "A unique string that identifies a cluster. The create-cluster command returns this identifier. You can use the list-clusters command to get cluster IDs.",
        ...
        },
        {
            ...
            description: "Returns the Amazon EMR block public access configuration for your AWS account in the current Region. For more information see Configure Block Public Access for Amazon EMR in the Amazon EMR Management Guide.",
            options: [
                {
                    name: "--cli-input-json",
                    description: "Performs service operation based on the JSON string provided. The JSON string follows the format provided by ``--generate-cli-skeleton``. If other arguments are provided on the command line, the CLI values will override the JSON-provided values. It is not possible to pass arbitrary binary values using a JSON-provided value as the string will be taken literally.",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--identity-id",
                    description: "The globally unique identifier (GUID) of the user or group. For more information, see UserId and GroupId in the AWS SSO Identity Store API Reference. Either IdentityName or IdentityId must be specified.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--identity-name",
                    description: "The name of the user or group to fetch. For more information, see UserName and DisplayName in the AWS SSO Identity Store API Reference. Either IdentityName or IdentityId must be specified.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Lists all available details about the instance fleets in a cluster.  The instance fleet configuration is available only in Amazon EMR versions 4.8.0 and later, excluding 5.0.x versions.",
            options: [
                {
                    name: "--cluster-id",
                    description: "The unique identifier of the cluster.",
        ...
        {
            name: "list-steps",
            description: "Provides a list of steps for the cluster in reverse order unless you specify stepIds with the request of filter by StepStates. You can specify a maximum of 10 stepIDs.",
            options: [
                {
                    name: "--cluster-id",
        ...
        {
            name: "list-studios",
            description: "Returns a list of all Amazon EMR Studios associated with the AWS account. The list includes details such as ID, Studio Access URL, and creation time for each Studio.",
            options: [
                {
                    name: "--marker",
                    description: "The pagination token that indicates the set of results to retrieve.",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The number of steps that can be executed concurrently. You can specify a minimum of 1 step and a maximum of 256 steps.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Creates or updates an Amazon EMR block public access configuration for your AWS account in the current Region. For more information see Configure Block Public Access for Amazon EMR in the Amazon EMR Management Guide.",
            options: [
                {
        ...
        {
            name: "remove-tags",
            description: "Removes tags from an Amazon EMR resource. Tags make it easier to associate clusters in various ways, such as grouping clusters to track your Amazon EMR resource allocation costs. For more information, see Tag Clusters.  The following example removes the stack tag with value Prod from a cluster:",
            options: [
                {
                    name: "--resource-id",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--identity-name",
                    description: "The name of the user or group to update. For more information, see UserName and DisplayName in the AWS SSO Identity Store API Reference. Either IdentityName or IdentityId must be specified.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Modifies the cluster attributes 'visible-to-all-users' and 'termination-protected'.",
            options: [
                {
                    name: "--cluster-id",
                    description: "A unique string that identifies a cluster. The create-cluster command returns this identifier. You can use the list-clusters command to get cluster IDs.",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--visible-to-all-users",
                    description: "Specifies whether the cluster is visible to all IAM users of the AWS account associated with the cluster. If set to --visible-to-all-users, all IAM users of that AWS account can view it. If they have the proper policy permissions set, they can  also manage the cluster. If it is set to --no-visible-to-all-users, only the IAM user that created the cluster can view and manage it.  Clusters are visible by default.",
                },
                {
                    name: "--no-visible-to-all-users",
                },
                {
                    ...
                    description: "Specifies that the debugging tool is enabled for the cluster, which allows you to browse log files using the Amazon EMR console. Turning debugging on requires that you specify --log-uri because log files must be stored in Amazon S3 so that Amazon EMR can index them for viewing in the console.",
                },
                {
                ...
                },
                {
                    ...
                    description: "Specifies additional information during cluster creation.",
                    args: {
                        name: "string",
                    },
                },
