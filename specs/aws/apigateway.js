var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Adds a new Authorizer resource to an existing RestApi resource. AWS CLI",
            options: [
                {
                    name: "--rest-api-id",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--domain-name",
                    description: "[Required] The domain name of the BasePathMapping resource to delete.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--base-path",
                    description: "[Required] The base path name of the BasePathMapping resource to delete. To specify an empty base path, set this parameter to '(none)'.",
                    args: {
                        name: "string",
                    },
                },
            ...
            options: [
                {
                    ...
                    description: "[Required] The identifier of the ClientCertificate resource to be deleted.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--deployment-id",
                    description: "[Required] The identifier of the Deployment resource to delete.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--domain-name",
                    description: "[Required] The domain name of the BasePathMapping resource to be described.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--domain-name",
                    description: "[Required] The domain name of a BasePathMapping resource.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--client-certificate-id",
                    description: "[Required] The identifier of the ClientCertificate resource to be described.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--deployment-id",
                    description: "[Required] The identifier of the Deployment resource to get information about.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--sdk-type",
                    description: "[Required] The language for the generated SDK. Currently java, javascript, android, objectivec (for iOS), swift (for iOS), and ruby are supported.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-id",
                    description: "[Required] The Resource identifier for the new Method resource.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "[Required] The key-value map of strings. The valid character set is [a-zA-Z+-=._:/]. The tag key can be up to 128 characters and must not start with aws:. The tag value can be up to 256 characters.",
                    args: {
                        name: "map",
                    },
                },
        ...
        },
        {
            ...
            description: "Simulate the execution of an Authorizer in your RestApi with headers, parameters, and an incoming request body.  Use Lambda Function as Authorizer Use Cognito User Pool as Authorizer",
            options: [
                {
                    name: "--rest-api-id",
                    description: "[Required] The string identifier of the associated RestApi.",
                ...
                {
                    name: "--authorizer-id",
                    description: "[Required] Specifies a test invoke authorizer request's Authorizer ID.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--domain-name",
                    description: "[Required] The domain name of the BasePathMapping resource to change.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--base-path",
                    description: "[Required] The base path of the BasePathMapping resource to change. To specify an empty base path, set this parameter to '(none)'.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--client-certificate-id",
                    description: "[Required] The identifier of the ClientCertificate resource to be updated.",
                    args: {
                        name: "string",
                    },
                },
