var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Returns information about the specified global table.  This operation only applies to Version 2017.11.29 of global tables. If you are using global tables Version 2019.11.21 you can use DescribeTable instead.",
            options: [
                {
                    name: "--global-table-name",
        ...
        },
        {
            ...
            description: "Describes Region-specific settings for a global table.  This operation only applies to Version 2017.11.29 of global tables.",
            options: [
                {
                    name: "--global-table-name",
        ...
        },
        {
            ...
            description: "Describes auto scaling settings across replicas of the global table at once.  This operation only applies to Version 2019.11.21 of global tables.",
            options: [
                {
                    name: "--table-name",
                    description: "The name of the table.",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Type of encryption used on the bucket where export data will be stored. Valid values for S3SseAlgorithm are:    AES256 - server-side encryption with Amazon S3 managed keys    KMS - server-side encryption with AWS KMS managed keys",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--backup-type",
                    description: "The backups from the table specified by BackupType are listed. Where BackupType can be:    USER - On-demand backup created by you.    SYSTEM - On-demand backup automatically created by DynamoDB.    ALL - All types of on-demand backups (USER and SYSTEM).",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Lists all global tables that have a replica in the specified Region.  This operation only applies to Version 2017.11.29 of global tables.",
            options: [
                {
        ...
        },
        {
            ...
            options: [
                {
                    name: "--transact-items",
                    description: "An ordered array of up to 25 TransactWriteItem objects, each of which contains a ConditionCheck, Put, Update, or Delete object. These can operate on items in different tables, but the tables must reside in the same AWS account and Region, and no two of them can operate on the same item.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--stream-specification",
                    description: "Represents the DynamoDB Streams configuration for the table.  You receive a ResourceInUseException if you try to enable a stream on a table that already has a stream, or if you try to disable a stream on a table that doesn't have a stream.",
                    args: {
                        name: "structure",
                    },
                },
                ...
                {
                    name: "--replica-updates",
                    description: "A list of replica update actions (create, delete, or update) for the table.  This property only applies to Version 2019.11.21 of global tables.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Updates auto scaling settings on your global tables at once.  This operation only applies to Version 2019.11.21 of global tables.",
            options: [
                {
                    name: "--global-secondary-index-updates",
