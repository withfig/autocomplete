        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, as opposed to the default method, Easy DKIM. You can only specify this object if the email identity is a domain, as opposed to an address.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
            ...
            options: [
                {
                    ...
                    description: "Enables or disables the automatic warm-up feature for dedicated IP addresses that are associated with your Amazon SES account in the current AWS Region. Set to true to enable the automatic warm-up feature, or set to false to disable it.",
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The method that you want to use to configure DKIM for the identity. There are two possible values:    AWS_SES \u2013 Configure DKIM for the identity by using Easy DKIM.    EXTERNAL \u2013 Configure DKIM for the identity by using Bring Your Own DKIM (BYODKIM).",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
