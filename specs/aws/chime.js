var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Creates up to 100 new attendees for an active Amazon Chime SDK meeting. For more information about the Amazon Chime SDK, see Using the Amazon Chime SDK in the Amazon Chime Developer Guide.",
            options: [
                {
                    name: "--meeting-id",
        ...
        },
        {
            ...
            description: "Creates an Amazon Chime SDK messaging AppInstance under an AWS account. Only SDK messaging customers use this API. CreateAppInstance supports idempotency behavior as described in the AWS API Standard.",
            options: [
                {
                    name: "--name",
        ...
        },
        {
            ...
            description: "Promotes an AppInstanceUser to an AppInstanceAdmin. The promoted user can perform the following actions.     ChannelModerator actions across all channels in the AppInstance.    DeleteChannelMessage actions.   Only an AppInstanceUser can be promoted to an AppInstanceAdmin role.",
            options: [
                {
        ...
        {
            name: "create-channel",
            description: "Creates a channel to which you can add users and send messages.  Restriction: You can't change a channel's privacy.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--app-instance-arn",
        ...
        },
        {
            ...
            description: "Demotes an AppInstanceAdmin to an AppInstanceUser. This action does not delete the user.",
            options: [
                {
                    name: "--app-instance-admin-arn",
        ...
        {
            name: "delete-channel",
            description: "Immediately makes a channel and its memberships inaccessible and marks them for deletion. This is an irreversible process.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
        ...
        },
        {
            ...
            description: "Removes a user from a channel's ban list.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
        ...
        },
        {
            ...
            description: "Deletes a channel moderator.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
                    description: "The ARN of the channel.",
        ...
        },
        {
            ...
            description: "Moves the specified phone number into the Deletionqueue. A phone number must be disassociated from any users or Amazon Chime Voice Connectors before it can be deleted.  Deleted phone numbers remain in the Deletion queue for 7 days before they are deleted permanently.",
            options: [
                {
        ...
        },
        {
            ...
            description: "Deletes the specified Amazon Chime Voice Connector group. Any VoiceConnectorItems and phone numbers associated with the group must be removed before it can be deleted.",
            options: [
                {
                    name: "--voice-connector-group-id",
                    description: "The Amazon Chime Voice Connector group ID.",
        ...
        },
        {
            ...
            description: "Deletes the origination settings for the specified Amazon Chime Voice Connector.  If emergency calling is configured for the Amazon Chime Voice Connector, it must be deleted prior to deleting the origination settings.",
            options: [
                {
                    name: "--voice-connector-id",
                    description: "The Amazon Chime Voice Connector ID.",
        ...
        },
        {
            ...
            description: "Deletes the termination settings for the specified Amazon Chime Voice Connector.  If emergency calling is configured for the Amazon Chime Voice Connector, it must be deleted prior to deleting the termination settings.",
            options: [
                {
                    name: "--voice-connector-id",
                    description: "The Amazon Chime Voice Connector ID.",
        ...
        },
        {
            ...
            description: "Returns the full details of a channel in an Amazon Chime AppInstance.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
                    description: "The ARN of the channel.",
        ...
        },
        {
            ...
            description: "Returns the full details of a channel ban.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
        ...
        },
        {
            ...
            description: "Returns the full details of a user's channel membership.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
                    description: "The ARN of the channel.",
        ...
        },
        {
            ...
            description: "Returns the details of a channel based on the membership of the specified AppInstanceUser.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
        ...
        },
        {
            ...
            description: "Returns the full details of a channel moderated by the specified AppInstanceUser.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
        ...
        },
        {
            ...
            description: "Gets the full details of a channel message.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
                    description: "The ARN of the channel.",
        ...
        },
        {
            ...
            description: "Retrieves information about the last time a SIP OPTIONS ping was received from your SIP infrastructure for the specified Amazon Chime Voice Connector.",
            options: [
                {
                    name: "--voice-connector-id",
                    description: "The Amazon Chime Voice Connector ID.",
        ...
        {
            name: "list-accounts",
            description: "Lists the Amazon Chime accounts under the administrator's AWS account. You can filter accounts by account name prefix. To find out which Amazon Chime account a user belongs to, toucan filter by the user's email address, which returns one account result.",
            options: [
                {
                    name: "--name",
        ...
        },
        {
            ...
            description: "Lists all the users banned from a particular channel.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
                    description: "The ARN of the channel.",
        ...
        },
        {
            ...
            description: "Lists all channel memberships in a channel.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
        ...
        },
        {
            ...
            description: "Lists all channels that a particular AppInstanceUser is a part of. Only an AppInstanceAdmin can call the API with a user ARN that is not their own.   The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--app-instance-user-arn",
        ...
        },
        {
            ...
            description: "Lists all the moderators for a channel.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
                    description: "The ARN of the channel.",
        ...
        },
        {
            ...
            description: "A list of the channels moderated by an AppInstanceUser.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--app-instance-user-arn",
        ...
        {
            name: "list-meetings",
            description: "Lists up to 100 active Amazon Chime SDK meetings. For more information about the Amazon Chime SDK, see Using the Amazon Chime SDK in the Amazon Chime Developer Guide .",
            options: [
                {
                    name: "--next-token",
                    description: "The token to use to retrieve the next page of results.",
        ...
        },
        {
            ...
            description: "Adds origination settings for the specified Amazon Chime Voice Connector.  If emergency calling is configured for the Amazon Chime Voice Connector, it must be deleted prior to turning off origination settings.",
            options: [
                {
                    name: "--voice-connector-id",
                    description: "The Amazon Chime Voice Connector ID.",
        ...
        },
        {
            ...
            description: "Adds termination settings for the specified Amazon Chime Voice Connector.  If emergency calling is configured for the Amazon Chime Voice Connector, it must be deleted prior to turning off termination settings.",
            options: [
                {
                    name: "--voice-connector-id",
                    description: "The Amazon Chime Voice Connector ID.",
        ...
        },
        {
            ...
            description: "Redacts message content, but not metadata. The message exists in the back end, but the action returns null content, and the state shows as redacted.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
        ...
        {
            name: "update-channel",
            description: "Update a channel's attributes.  Restriction: You can't change a channel's privacy.   The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
                    description: "The ARN of the channel.",
        ...
        },
        {
            ...
            description: "Updates the content of a message.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
                    description: "The ARN of the channel.",
        ...
        },
        {
            ...
            description: "The details of the time when a user last read messages in a channel.  The x-amz-chime-bearer request header is mandatory. Use the AppInstanceUserArn of the user that makes the API call as the value in the header.",
            options: [
                {
                    name: "--channel-arn",
                    description: "The ARN of the channel.",
