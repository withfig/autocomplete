    ...
    subcommands: [
            ...
            options: [
                {
                    ...
                    description: "A unique string that identifies the request and that allows failed requests to be retried without the risk of executing the operation twice. CreatorRequestId can be any unique string, for example, a date/time stamp.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--priority",
                    description: "The setting that determines the processing order of the rule group among the rule groups that you associate with the specified VPC. DNS Firewall filters VPC traffic starting from rule group with the lowest numeric priority setting.  You must specify a unique priority for each rule group that you associate with a single VPC. To make it easier to insert rule groups later, leave space between the numbers, for example, use 100, 200, and so on. You can change the priority setting for a rule group association after you create it.",
                    args: {
                        name: "integer",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--creator-request-id",
                    description: "A unique string that identifies the request and that allows you to retry failed requests without the risk of executing the operation twice. CreatorRequestId can be any unique string, for example, a date/time stamp.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--target-ips",
                    description: "The IPs that you want Resolver to forward DNS queries to. You can specify only IPv4 addresses. Separate IP addresses with a comma.  TargetIps is available only when the value of Rule type is FORWARD.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Retrieves the configuration of the firewall behavior provided by DNS Firewall for a single Amazon virtual private cloud (VPC).",
            options: [
                {
                    name: "--resource-id",
                    description: "The ID of the Amazon virtual private cloud (VPC) that the configuration is for.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Returns the AWS Identity and Access Management (AWS IAM) policy for sharing the specified rule group. You can use the policy to share the rule group using AWS Resource Access Manager (RAM).",
            options: [
                {
                    name: "--arn",
        ...
        },
        {
            ...
            description: "Gets information about a query logging policy. A query logging policy specifies the Resolver query logging operations and resources that you want to allow another AWS account to be able to use.",
            options: [
                {
                    name: "--arn",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The fully qualified URL or URI of the file stored in Amazon Simple Storage Service (S3) that contains the list of domains to import. The file must be in an S3 bucket that's in the same Region as your DNS Firewall. The file must be a text file and must contain a single domain per line.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Lists the configurations for DNSSEC validation that are associated with the current AWS account.",
            options: [
                {
                    name: "--max-results",
        ...
        },
        {
            ...
            description: "Attaches an AWS Identity and Access Management (AWS IAM) policy for sharing the rule group. You can use the policy to share the rule group using AWS Resource Access Manager (RAM).",
            options: [
                {
                    name: "--arn",
                ...
                },
                {
                    ...
                    description: "The AWS Identity and Access Management (AWS IAM) policy to attach to the rule group.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Specifies an AWS account that you want to share a query logging configuration with, the query logging configuration that you want to share, and the operations that you want the account to be able to perform on the configuration.",
            options: [
                {
                    name: "--arn",
        ...
        },
        {
            ...
            description: "Specifies an AWS rule that you want to share with another account, the account that you want to share the rule with, and the operations that you want the account to be able to perform on the rule.",
            options: [
                {
                    name: "--arn",
        ...
        },
        {
            ...
            description: "Updates the configuration of the firewall behavior provided by DNS Firewall for a single Amazon virtual private cloud (VPC).",
            options: [
                {
                    name: "--resource-id",
                    description: "The ID of the Amazon virtual private cloud (VPC) that the configuration is for.",
