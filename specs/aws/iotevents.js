var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Retrieves execution information about a detector model analysis",
            options: [
                {
                    name: "--analysis-id",
        ...
        },
        {
            ...
            description: "Performs an analysis of your detector model. For more information, see Running detector model analyses in the AWS IoT Events Developer Guide.",
            options: [
                {
                    name: "--detector-model-definition",
