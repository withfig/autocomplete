var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Creates a named query in the specified workgroup. Requires that you have access to the workgroup. For code samples using the AWS SDK for Java, see Examples and Code Samples in the Amazon Athena User Guide.",
            options: [
                {
                    name: "--name",
        ...
        },
        {
            ...
            description: "Deletes the named query if you have access to the workgroup in which the query was saved. For code samples using the AWS SDK for Java, see Examples and Code Samples in the Amazon Athena User Guide.",
            options: [
                {
                    name: "--named-query-id",
        ...
        },
        {
            ...
            description: "Stops a query execution. Requires you to have access to the workgroup in which the query ran. For code samples using the AWS SDK for Java, see Examples and Code Samples in the Amazon Athena User Guide.",
            options: [
                {
                    name: "--query-execution-id",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--type",
                    description: "Specifies the type of data catalog to update. Specify LAMBDA for a federated catalog or HIVE for an external hive metastore.  Do not use the GLUE type. This refers to the AwsDataCatalog that already exists in your account, of which you can have only one. Specifying the GLUE type will result in an INVALID_INPUT error.",
                    args: {
                        name: "string",
                    },
                },
