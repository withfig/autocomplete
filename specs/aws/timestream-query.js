    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--query-id",
                    description: "The id of the query that needs to be cancelled. QueryID is returned as part of QueryResult.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
