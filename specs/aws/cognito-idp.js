var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Creates a new user in the specified user pool. If MessageAction is not set, the default is to send a welcome message via email or phone (SMS). This message is based on a template that you configured in your call to create or update a user pool. This template includes your custom sign-up instructions and placeholders for user name and temporary password. Alternatively, you can call AdminCreateUser with \u201cSUPPRESS\u201d for the MessageAction parameter, and Amazon Cognito will not send any email.  In either case, the user will be in the FORCE_CHANGE_PASSWORD state until they sign in and change their password.  AdminCreateUser requires developer credentials.",
            options: [
                {
                    name: "--user-pool-id",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "An array of strings representing the user attribute names you wish to delete. For custom attributes, you must prepend the custom: prefix to the attribute name.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Disables the specified user. Calling this action requires developer credentials.",
            options: [
                {
                    name: "--user-pool-id",
        ...
        },
        {
            ...
            description: "Initiates the authentication flow, as an administrator. Calling this action requires developer credentials.",
            options: [
                {
                    name: "--user-pool-id",
        ...
        },
        {
            ...
            description: "Responds to an authentication challenge, as an administrator. Calling this action requires developer credentials.",
            options: [
                {
                    name: "--user-pool-id",
                    description: "The ID of the Amazon Cognito user pool.",
                ...
                {
                    name: "--session",
                    description: "The session which should be passed both ways in challenge-response calls to the service. If InitiateAuth or RespondToAuthChallenge API call determines that the caller needs to go through another challenge, they return a session with other challenge parameters. This session should be passed as it is to the next RespondToAuthChallenge API call.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "This action is no longer supported. You can use it to configure only SMS MFA. You can't use it to configure TOTP software token MFA. To configure either type of MFA, use AdminSetUserMFAPreference instead.",
            options: [
                {
                    name: "--user-pool-id",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The confirmation code sent by a user's request to retrieve a forgotten password. For more information, see ForgotPassword.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--scopes",
                    description: "A list of scopes. Each scope is map, where the keys are name and description.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--lambda-config",
                    description: "The Lambda trigger configuration information for the new user pool.  In a push model, event sources (such as Amazon S3 and custom applications) need permission to invoke a function. So you will need to make an extra call to add permission for these event sources to invoke your Lambda function.  For more information on using the Lambda API to add permission, see  AddPermission .  For adding permission using the AWS CLI, see  add-permission .",
                    args: {
                        name: "structure",
                    },
                },
                ...
                },
                {
                    ...
                    description: 'You can choose to set case sensitivity on the username input for the selected sign-in option. For example, when this is set to False, users will be able to sign in using either "username" or "Username". This configuration is immutable once it has been set. For more information, see UsernameConfigurationType.',
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The user pool attributes that the app client can write to. If your app client allows users to sign in through an identity provider, this array must include all attributes that are mapped to identity provider attributes. Amazon Cognito updates mapped attributes when users sign in to your application through an identity provider. If your app client lacks write access to a mapped attribute, Amazon Cognito throws an error when it attempts to update the attribute. For more information, see Specifying Identity Provider Attribute Mappings for Your User Pool.",
                    args: {
                        name: "list",
                    },
                },
                ...
                },
                {
                    ...
                    description: "The Amazon Pinpoint analytics configuration for collecting metrics for this user pool.  In regions where Pinpoint is not available, Cognito User Pools only supports sending events to Amazon Pinpoint projects in us-east-1. In regions where Pinpoint is available, Cognito User Pools will support sending events to Amazon Pinpoint projects within that same region.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--analytics-metadata",
                    description: "The Amazon Pinpoint analytics metadata for collecting metrics for ForgotPassword calls.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            description: "Gets the UI Customization information for a particular app client's app UI, if there is something set. If nothing is set for the particular client, but there is an existing pool level customization (app clientId will be ALL), then that is returned. If nothing is present, then an empty shape is returned.",
            options: [
                {
                    name: "--user-pool-id",
                    description: "The user pool ID for the user pool.",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--analytics-metadata",
                    description: "The Amazon Pinpoint analytics metadata for collecting metrics for InitiateAuth calls.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--analytics-metadata",
                    description: "The Amazon Pinpoint analytics metadata for collecting metrics for ResendConfirmationCode calls.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--challenge-name",
                    description: "The challenge name. For more information, see InitiateAuth.  ADMIN_NO_SRP_AUTH is not a valid value.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--analytics-metadata",
                    description: "The Amazon Pinpoint analytics metadata for collecting metrics for RespondToAuthChallenge calls.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        },
        {
            ...
            description: "Configures actions on detected risks. To delete the risk configuration for UserPoolId or ClientId, pass null values for all four configuration types. To enable Amazon Cognito advanced security features, update the user pool to include the UserPoolAddOns keyAdvancedSecurityMode.",
            options: [
                {
                    name: "--user-pool-id",
                    description: "The user pool ID.",
        ...
        },
        {
            ...
            description: "This action is no longer supported. You can use it to configure only SMS MFA. You can't use it to configure TOTP software token MFA. To configure either type of MFA, use SetUserMFAPreference instead.",
            options: [
                {
                    name: "--access-token",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--analytics-metadata",
                    description: "The Amazon Pinpoint analytics metadata for collecting metrics for SignUp calls.",
                    args: {
                        name: "structure",
                    },
                },
        ...
        {
            name: "update-group",
            description: "Updates the specified group with the specified attributes. Calling this action requires developer credentials.  If you don't provide a value for an attribute, it will be set to the default value.",
            options: [
                {
                    name: "--group-name",
                    description: "The name of the group.",
        ...
        },
        {
            ...
            description: "Updates the name and scopes of resource server. All other fields are read-only.  If you don't provide a value for an attribute, it will be set to the default value.",
            options: [
                {
                    name: "--user-pool-id",
                    description: "The user pool ID for the user pool.",
        ...
        },
        {
            ...
            description: "Updates the specified user pool with the specified attributes. You can get a list of the current user pool settings using DescribeUserPool.  If you don't provide a value for an attribute, it will be set to the default value.",
            options: [
                {
                    name: "--user-pool-id",
        ...
        },
        {
            ...
            description: "Updates the specified user pool app client with the specified attributes. You can get a list of the current user pool app client settings using DescribeUserPoolClient.  If you don't provide a value for an attribute, it will be set to the default value.",
            options: [
                {
                    name: "--user-pool-id",
        ...
        },
        {
            ...
            description: "Updates the Secure Sockets Layer (SSL) certificate for the custom domain for your user pool. You can use this operation to provide the Amazon Resource Name (ARN) of a new certificate to Amazon Cognito. You cannot use it to change the domain for a user pool. A custom domain is used to host the Amazon Cognito hosted UI, which provides sign-up and sign-in pages for your application. When you set up a custom domain, you provide a certificate that you manage with AWS Certificate Manager (ACM). When necessary, you can use this operation to change the certificate that you applied to your custom domain. Usually, this is unnecessary following routine certificate renewal with ACM. When you renew your existing certificate in ACM, the ARN for your certificate remains the same, and your custom domain uses the new certificate automatically. However, if you replace your existing certificate with a new one, ACM gives the new certificate a new ARN. To apply the new certificate to your custom domain, you must provide this ARN to Amazon Cognito. When you add your new certificate in ACM, you must choose US East (N. Virginia) as the AWS Region. After you submit your request, Amazon Cognito requires up to 1 hour to distribute your new certificate to your custom domain. For more information about adding a custom domain to your user pool, see Using Your Own Domain for the Hosted UI.",
            options: [
                {
                    name: "--domain",
                    description: "The domain name for the custom domain that hosts the sign-up and sign-in pages for your application. For example: auth.example.com.  This string can include only lowercase letters, numbers, and hyphens. Do not use a hyphen for the first or last character. Use periods to separate subdomain names.",
                    args: {
                        name: "string",
                    },
                },
