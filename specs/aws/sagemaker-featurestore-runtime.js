var completionSpec = {
    ...
    subcommands: [
        {
            name: "delete-record",
            description: "Deletes a Record from a FeatureGroup. A new record will show up in the OfflineStore when the DeleteRecord API is called. This record will have a value of True in the is_deleted column.",
            options: [
                {
