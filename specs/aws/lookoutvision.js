var completionSpec = {
    ...
    subcommands: [
        ...
        {
            name: "list-models",
            description: "Lists the versions of a model in an Amazon Lookout for Vision project. This operation requires permissions to perform the lookoutvision:ListModels operation.",
            options: [
                {
                    name: "--project-name",
        ...
        {
            name: "list-projects",
            description: "Lists the Amazon Lookout for Vision projects in your AWS account. This operation requires permissions to perform the lookoutvision:ListProjects operation.",
            options: [
                {
                    name: "--next-token",
