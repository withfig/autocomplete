var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Creates a simulation job.  After 90 days, simulation jobs expire and will be deleted. They will no longer be accessible.",
            options: [
                {
                    name: "--client-request-token",
                    description: "Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.",
                ...
                },
                {
                    ...
                    description: "The failure behavior the simulation job.  Continue  Restart the simulation job in the same host instance.  Fail  Stop the simulation job and terminate the instance.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Starts a new simulation job batch. The batch is defined using one or more SimulationJobRequest objects.",
            options: [
                {
                    name: "--client-request-token",
                    description: "Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.",
        ...
        {
            name: "untag-resource",
            description: "Removes the specified tags from the specified AWS RoboMaker resource. To remove a tag, specify the tag key. To change the tag value of an existing tag key, use  TagResource .",
            options: [
                {
                    name: "--resource-arn",
