    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filters",
                    description: "Filters to scope the results. The following filters are supported:    LicenseARN     Status     PrincipalARN     ParentARN",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filters",
                    description: "Filters to scope the results. The following filters are supported:    Beneficiary     ProductSKU     KeyFingerprint     Status",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filters",
                    description: "Filters to scope the results. The following filters are supported:    LicenseARN     Status",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filters",
                    description: "Filters to scope the results. The following filters are supported:    ProductSKU     Status     KeyFingerprint     Issuer",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
