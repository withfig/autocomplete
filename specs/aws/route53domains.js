    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--domain-name",
                    description: "The name of the domain that was specified when another AWS account submitted a TransferDomainToAnotherAwsAccount request.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--auto-renew",
                    description: "Indicates whether the domain will be automatically renewed (true) or not (false). Autorenewal only takes effect after the account is charged. Default: true",
                },
                {
                    name: "--no-auto-renew",
                    description: "Indicates whether the domain will be automatically renewed (true) or not (false). Autorenewal only takes effect after the account is charged. Default: true",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--account-id",
                    description: "The account ID of the AWS account that you want to transfer the domain to, for example, 111122223333.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
