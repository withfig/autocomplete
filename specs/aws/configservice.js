    ...
    subcommands: [
        {
            ...
            description: "Returns the current configuration items for resources that are present in your AWS Config aggregator. The operation also returns a list of resources that are not processed in the current request. If there are no unprocessed resources, the operation returns an empty unprocessedResourceIdentifiers list.     The API does not return results for deleted resources.    The API does not return tags and relationships.",
            options: [
                {
        ...
        },
        {
            ...
            description: "Returns the current configuration for one or more requested resources. The operation also returns a list of resources that are not processed in the current request. If there are no unprocessed resources, the operation returns an empty unprocessedResourceKeys list.     The API does not return results for deleted resources.    The API does not return any tags for the requested resources. This information is filtered out of the supplementaryConfiguration section of the API response.",
            options: [
                {
                    name: "--resource-keys",
        ...
        },
        {
            ...
            description: "Deletes the specified conformance pack and all the AWS Config rules, remediation actions, and all evaluation results within that conformance pack. AWS Config sets the conformance pack to DELETE_IN_PROGRESS until the deletion is complete. You cannot update a conformance pack while it is in this state.",
            options: [
                {
        ...
        },
        {
            ...
            description: "Deletes the delivery channel. Before you can delete the delivery channel, you must stop the configuration recorder by using the StopConfigurationRecorder action.",
            options: [
                {
        ...
        },
        {
            ...
            description: "Deletes the evaluation results for the specified AWS Config rule. You can specify one AWS Config rule per request. After you delete the evaluation results, you can call the StartConfigRulesEvaluation API to start evaluating your AWS resources against the rule.",
            options: [
                {
                    name: "--config-rule-name",
                    description: "The name of the AWS Config rule for which you want to delete the evaluation results.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Deletes the specified organization conformance pack and all of the config rules and remediation actions from all member accounts in that organization.   Only a master account or a delegated administrator account can delete an organization conformance pack. When calling this API with a delegated administrator, you must ensure AWS Organizations ListDelegatedAdministrator permissions are added. AWS Config sets the state of a conformance pack to DELETE_IN_PROGRESS until the deletion is complete. You cannot update a conformance pack while it is in this state.",
            options: [
                {
        ...
        },
        {
            ...
            options: [
                {
                    name: "--config-rule-name",
                    description: "The name of the AWS Config rule for which you want to delete remediation configuration.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Deletes one or more remediation exceptions mentioned in the resource keys.  AWS Config generates a remediation exception when a problem occurs executing a remediation action to a specific resource. Remediation exceptions blocks auto-remediation until the exception is cleared.",
            options: [
                {
                    name: "--config-rule-name",
                    description: "The name of the AWS Config rule for which you want to delete remediation exception configuration.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--resource-keys",
                    description: "An exception list of resource exception keys to be processed with the current request. AWS Config adds exception for each resource key. For example, AWS Config adds 3 exceptions for 3 resource keys.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Records the configuration state for a custom resource that has been deleted. This API records a new ConfigurationItem with a ResourceDeleted status. You can retrieve the ConfigurationItems recorded for this resource in your AWS Config History.",
            options: [
                {
                    name: "--resource-type",
        ...
        },
        {
            ...
            description: "Deletes the stored query for a single AWS account and a single AWS Region.",
            options: [
                {
                    name: "--query-name",
        ...
        },
        {
            ...
            description: "Returns a list of compliant and noncompliant rules with the number of resources for compliant and noncompliant rules.   The results can return an empty result page, but if you have a nextToken, the results are displayed on the next page.",
            options: [
                {
                    name: "--configuration-aggregator-name",
                    description: "The name of the configuration aggregator.",
        ...
        },
        {
            ...
            description: "Returns a list of the conformance packs and their associated compliance status with the count of compliant and noncompliant AWS Config rules within each conformance pack. Also returns the total rule count which includes compliant rules, noncompliant rules, and rules that cannot be evaluated due to insufficient data.  The results can return an empty result page, but if you have a nextToken, the results are displayed on the next page.",
            options: [
                {
                    name: "--configuration-aggregator-name",
                    description: "The name of the configuration aggregator.",
                ...
                {
                    name: "--limit",
                    description: "The maximum number of conformance packs compliance details returned on each page. The default is maximum. If you specify 0, AWS Config uses the default.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--limit",
                    description: "The maximum number of AggregationAuthorizations returned on each page. The default is maximum. If you specify 0, AWS Config uses the default.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Filters the results by compliance. The allowed values are COMPLIANT and NON_COMPLIANT.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--limit",
                    description: "The number of rule evaluation results that you want returned. This parameter is required if the rule limit for your account is more than the default of 150 rules. For information about requesting a rule limit increase, see AWS Config Limits in the AWS General Reference Guide.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns the current status of the specified configuration recorder. If a configuration recorder is not specified, this action returns the status of all configuration recorders associated with the account.  Currently, you can specify only one configuration recorder per region in your account.",
            options: [
                {
        ...
        },
        {
            ...
            description: "Returns the details for the specified configuration recorders. If the configuration recorder is not specified, this action returns the details for all configuration recorders associated with the account.  Currently, you can specify only one configuration recorder per region in your account.",
            options: [
                {
                    name: "--configuration-recorder-names",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--limit",
                    description: "The maximum number of AWS Config rules within a conformance pack are returned on each page.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--conformance-pack-names",
                    description: "Comma-separated list of conformance pack names for which you want details. If you do not specify any names, AWS Config returns details for all your conformance packs.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns the current status of the specified delivery channel. If a delivery channel is not specified, this action returns the current status of all delivery channels associated with the account.  Currently, you can specify only one delivery channel per region in your account.",
            options: [
                {
        ...
        },
        {
            ...
            description: "Returns details about the specified delivery channel. If a delivery channel is not specified, this action returns the details of all delivery channels associated with the account.  Currently, you can specify only one delivery channel per region in your account.",
            options: [
                {
                    name: "--delivery-channel-names",
                    description: "A list of delivery channel names.",
            ...
            options: [
                {
                    ...
                    description: "The names of organization config rules for which you want status details. If you do not specify any names, AWS Config returns details for all your organization AWS Confg rules.",
                    args: {
                        name: "list",
                    },
                },
                {
                    name: "--limit",
                    description: "The maximum number of OrganizationConfigRuleStatuses returned on each page. If you do no specify a number, AWS Config uses the default. The default is 100.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns a list of organization config rules.   When you specify the limit and the next token, you receive a paginated response. Limit and next token are not applicable if you specify organization config rule names. It is only applicable, when you request all the organization config rules.",
            options: [
                {
                    name: "--organization-config-rule-names",
                    description: "The names of organization config rules for which you want details. If you do not specify any names, AWS Config returns details for all your organization config rules.",
                    args: {
                        name: "list",
                    },
                },
                {
                    name: "--limit",
                    description: "The maximum number of organization config rules returned on each page. If you do no specify a number, AWS Config uses the default. The default is 100.",
                    args: {
                        name: "integer",
                    },
                },
            ...
            options: [
                {
                    ...
                    description: "The names of organization conformance packs for which you want status details. If you do not specify any names, AWS Config returns details for all your organization conformance packs.",
                    args: {
                        name: "list",
                    },
                },
                {
                    name: "--limit",
                    description: "The maximum number of OrganizationConformancePackStatuses returned on each page. If you do no specify a number, AWS Config uses the default. The default is 100.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--limit",
                    description: "The maximum number of organization config packs returned on each page. If you do no specify a number, AWS Config uses the default. The default is 100.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--config-rule-names",
                    description: "A list of AWS Config rule names of remediation configurations for which you want details.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--limit",
                    description: "The maximum number of RemediationExceptionResourceKey returned on each page. The default is 25. If you specify 0, AWS Config uses the default.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--limit",
                    description: "The maximum number of RemediationExecutionStatuses returned on each page. The default is maximum. If you specify 0, AWS Config uses the default.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns the details of one or more retention configurations. If the retention configuration name is not specified, this action returns the details for all the retention configurations for that account.  Currently, AWS Config supports only one retention configuration per region in your account.",
            options: [
                {
                    name: "--retention-configuration-names",
                    description: "A list of names of retention configurations for which you want details. If you do not specify a name, AWS Config returns details for all the retention configurations for that account.  Currently, AWS Config supports only one retention configuration per region in your account.",
                    args: {
                        name: "list",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns the evaluation results for the specified AWS Config rule for a specific resource in a rule. The results indicate which AWS resources were evaluated by the rule, when each resource was last evaluated, and whether each resource complies with the rule.   The results can return an empty result page. But if you have a nextToken, the results are displayed on the next page.",
            options: [
                {
                    name: "--configuration-aggregator-name",
                    description: "The name of the configuration aggregator.",
                ...
                },
                {
                    ...
                    description: "The resource compliance status.  For the GetAggregateComplianceDetailsByConfigRuleRequest data type, AWS Config supports only the COMPLIANT and NON_COMPLIANT. AWS Config does not support the NOT_APPLICABLE and INSUFFICIENT_DATA values.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns the count of compliant and noncompliant conformance packs across all AWS Accounts and AWS Regions in an aggregator. You can filter based on AWS Account ID or AWS Region.  The results can return an empty result page, but if you have a nextToken, the results are displayed on the next page.",
            options: [
                {
                    name: "--configuration-aggregator-name",
                    description: "The name of the configuration aggregator.",
                ...
                {
                    name: "--group-by-key",
                    description: "Groups the result based on AWS Account ID or AWS Region.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--limit",
                    description: "The maximum number of results returned on each page. The default is maximum. If you specify 0, AWS Config uses the default.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Returns the resource counts across accounts and regions that are present in your AWS Config aggregator. You can request the resource counts by providing filters and GroupByKey. For example, if the input contains accountID 12345678910 and region us-east-1 in filters, the API returns the count of resources in account ID 12345678910 and region us-east-1. If the input contains ACCOUNT_ID as a GroupByKey, the API returns resource counts for all source accounts that are present in your aggregator.",
            options: [
                {
                    name: "--configuration-aggregator-name",
                    description: "The name of the configuration aggregator.",
                ...
                {
                    name: "--limit",
                    description: "The maximum number of GroupedResourceCount objects returned on each page. The default is 1000. You cannot specify a number greater than 1000. If you specify 0, AWS Config uses the default.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--limit",
                    description: "The maximum number of evaluation results returned on each page. If you do no specify a number, AWS Config uses the default. The default is 100.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-types",
                    description: 'The comma-separated list that specifies the resource types that you want AWS Config to return (for example, "AWS::EC2::Instance", "AWS::IAM::User"). If a value for resourceTypes is not specified, AWS Config returns all resource types that AWS Config is recording in the region for your account.  If the configuration recorder is turned off, AWS Config returns an empty list of ResourceCount objects. If the configuration recorder is not recording a specific resource type (for example, S3 buckets), that resource type is not returned in the list of ResourceCount objects.',
                    args: {
                        name: "list",
                    },
                },
                {
                    name: "--limit",
                    description: "The maximum number of ResourceCount objects returned on each page. The default is 100. You cannot specify a number greater than 100. If you specify 0, AWS Config uses the default.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--limit",
                    description: "The maximum number of OrganizationConfigRuleDetailedStatus returned on each page. If you do not specify a number, AWS Config uses the default. The default is 100.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--limit",
                    description: "The maximum number of OrganizationConformancePackDetailedStatuses returned on each page. If you do not specify a number, AWS Config uses the default. The default is 100.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--limit",
                    description: "The maximum number of resource identifiers returned on each page. You cannot specify a number greater than 100. If you specify 0, AWS Config uses the default.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Lists the stored queries for a single AWS account and a single AWS Region. The default is 100.",
            options: [
                {
                    name: "--next-token",
                    description: "The nextToken string returned in a previous request that you use to request the next page of results in a paginated response.",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) that identifies the resource for which to list the tags. Currently, the supported resources are ConfigRule, ConfigurationAggregator and AggregatorAuthorization.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--limit",
                    description: "The maximum number of tags returned on each page. The limit maximum is 50. You cannot specify a number greater than 50. If you specify 0, AWS Config uses the default.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Location of file containing the template body (s3://bucketname/prefix). The uri must point to the conformance pack template (max size: 300 KB) that is located in an Amazon S3 bucket in the same region as the conformance pack.   You must have access to read Amazon S3 bucket.",
                    args: {
                        name: "string",
                    },
                },
                {
                    name: "--template-body",
                    description: "A string containing full conformance pack template body. Structure containing the template body with a minimum length of 1 byte and a maximum length of 51,200 bytes.  You can only use a YAML template with one resource type, that is, config rule and a remediation action.",
                    args: {
                        name: "string",
                    },
                },
                {
                    ...
                    description: "Amazon S3 bucket where AWS Config stores conformance pack templates.  This field is optional.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            description: "Add or updates the evaluations for process checks. This API checks if the rule is a process check when the name of the AWS Config rule is provided.",
            options: [
                {
                    name: "--config-rule-name",
                    description: "The name of the AWS Config rule.",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--template-s3-uri",
                    description: "Location of file containing the template body. The uri must point to the conformance pack template (max size: 300 KB).  You must have access to read Amazon S3 bucket.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--delivery-s3-bucket",
                    description: "Amazon S3 bucket where AWS Config stores conformance pack templates.  This field is optional. If used, it must be prefixed with awsconfigconforms.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--config-rule-name",
                    description: "The name of the AWS Config rule for which you want to create remediation exception.",
                    args: {
                        name: "string",
                    },
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-type",
                    description: "The type of the resource. The custom resource type must be registered with AWS CloudFormation.   You cannot use the organization names \u201caws\u201d, \u201camzn\u201d, \u201camazon\u201d, \u201calexa\u201d, \u201ccustom\u201d with custom resource types. It is the first part of the ResourceType up to the first ::.",
                    args: {
                        name: "string",
                    },
                },
                {
                    ...
                    description: "Version of the schema registered for the ResourceType in AWS CloudFormation.",
                    args: {
                        name: "string",
                    },
                },
                ...
                {
                    name: "--configuration",
                    description: "The configuration object of the resource in valid JSON format. It must match the schema registered with AWS CloudFormation.  The configuration JSON must not exceed 64 KB.",
                    args: {
                        name: "string",
                    },
                },
            ...
            options: [
                {
                    ...
                    description: "Number of days AWS Config stores your historical information.  Currently, only applicable to the configuration item history.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Saves a new query or updates an existing saved query. The QueryName must be unique for a single AWS account and a single AWS Region. You can create upto 300 queries in a single AWS account and a single AWS Region.",
            options: [
                {
                    name: "--stored-query",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "The maximum number of query results returned on each page. AWS Config also allows the Limit request parameter.",
                    args: {
                        name: "integer",
                    },
                },
        ...
        },
        {
            ...
            description: "Accepts a structured query language (SQL) SELECT command, performs the corresponding search, and returns resource configurations matching the properties. For more information about query components, see the  Query Components  section in the AWS Config Developer Guide.",
            options: [
                {
                    name: "--expression",
                    description: "The SQL query SELECT command.",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--config-rule-names",
                    description: "The list of names of AWS Config rules that you want to run evaluations for.",
                    args: {
                        name: "list",
                    },
                },
        ...
        {
            name: "subscribe",
            description: "Subcribes user to AWS Config by creating an AWS Config delivery channel and configuration recorder to track AWS resource configurations. The names of the default channel and configuration recorder will be default.",
            options: [
                {
                    name: "--s3-bucket",
