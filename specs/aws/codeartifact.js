    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "The format of the package that is copied. The valid package types are:     npm: A Node Package Manager (npm) package.     pypi: A Python Package Index (PyPI) package.     maven: A Maven package that contains compiled code in a distributable format, such as a JAR file.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                {
                    name: "--namespace",
                    description: "The namespace of the package. The package component that specifies its namespace depends on its type. For example:     The namespace of a Maven package is its groupId.     The namespace of an npm package is its scope.     A Python package does not contain a corresponding component, so Python packages do not have a namespace.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--versions",
                    description: "The versions of the package to copy.    You must specify versions or versionRevisions. You cannot specify both.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "The format of the package versions to delete. The valid values are:     npm     pypi     maven",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                },
                {
                    ...
                    description: "The expected status of the package version to delete. Valid values are:     Published     Unfinished     Unlisted     Archived     Disposed",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "A format that specifies the type of the requested package version. The valid values are:     npm     pypi     maven",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "A format that specifies the type of package versions you want to dispose. The valid values are:     npm     pypi     maven",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                {
                    name: "--expected-status",
                    description: "The expected status of the package version to dispose. Valid values are:     Published     Unfinished     Unlisted     Archived     Disposed",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Returns the resource policy attached to the specified domain.    The policy is a resource-based policy, not an identity-based policy. For more information, see Identity-based policies and resource-based policies  in the AWS Identity and Access Management User Guide.",
            options: [
                {
                    name: "--domain",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "A format that specifies the type of the package version with the requested asset file. The valid values are:     npm     pypi     maven",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "A format that specifies the type of the package version with the requested readme file. The valid values are:     npm     pypi     maven",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Returns the endpoint of a repository for a specific package format. A repository has one endpoint for each package format:     npm     pypi     maven",
            options: [
                {
                    name: "--domain",
                    description: "The name of the domain that contains the repository.",
                ...
                {
                    name: "--format",
                    description: "Returns which endpoint of a repository to return. A repository has one endpoint for each package format:     npm     pypi     maven",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        {
            name: "list-domains",
            description: "Returns a list of DomainSummary objects for all domains owned by the AWS account that makes this call. Each returned DomainSummary object contains information about a domain.",
            options: [
                {
                    name: "--max-results",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "The format of the package that contains the returned package version assets. The valid package types are:     npm: A Node Package Manager (npm) package.     pypi: A Python Package Index (PyPI) package.     maven: A Maven package that contains compiled code in a distributable format, such as a JAR file.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "The format of the package with the requested dependencies. The valid package types are:     npm: A Node Package Manager (npm) package.     pypi: A Python Package Index (PyPI) package.     maven: A Maven package that contains compiled code in a distributable format, such as a JAR file.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Returns a list of  PackageVersionSummary  objects for package versions in a repository that match the request parameters.",
            options: [
                {
                    name: "--domain",
                ...
                {
                    name: "--format",
                    description: "The format of the returned packages. The valid package types are:     npm: A Node Package Manager (npm) package.     pypi: A Python Package Index (PyPI) package.     maven: A Maven package that contains compiled code in a distributable format, such as a JAR file.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
                ...
                {
                    name: "--status",
                    description: "A string that specifies the status of the package versions to include in the returned list. It can be one of the following:     Published     Unfinished     Unlisted     Archived     Disposed",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "The format of the packages. The valid package types are:     npm: A Node Package Manager (npm) package.     pypi: A Python Package Index (PyPI) package.     maven: A Maven package that contains compiled code in a distributable format, such as a JAR file.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--package-prefix",
                    description: "A prefix used to filter returned packages. Only packages with names that start with packagePrefix are returned.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Returns a list of  RepositorySummary  objects. Each RepositorySummary contains information about a repository in the specified AWS account and that matches the input parameters.",
            options: [
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--format",
                    description: "A format that specifies the type of the package with the statuses to update. The valid values are:     npm     pypi     maven",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--dry-run",
                    description: "Only print the commands that would be executed to connect your tool with your repository without making any changes to your configuration",
                },
            ],
        },
    ],
