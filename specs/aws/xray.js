var completionSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Returns a list of tags that are applied to the specified AWS X-Ray group or sampling rule.",
            options: [
                {
                    name: "--resource-arn",
        ...
        {
            name: "tag-resource",
            description: "Applies tags to an existing AWS X-Ray group or sampling rule.",
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Number (ARN) of an X-Ray group or sampling rule.",
        ...
        {
            name: "untag-resource",
            description: "Removes tags from an AWS X-Ray group or sampling rule. You cannot edit or delete system tags (those with an aws: prefix).",
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Number (ARN) of an X-Ray group or sampling rule.",
