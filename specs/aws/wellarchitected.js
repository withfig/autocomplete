    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--lens-aliases",
                    description: "List of lens aliases to associate or disassociate with a workload. Identify a lens using its LensSummary$LensAlias.",
                    args: {
                        name: "list",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Create a new workload. The owner of a workload can share the workload with other AWS accounts and IAM users in the same AWS Region. Only the owner of a workload can delete it. For more information, see Defining a Workload in the AWS Well-Architected Tool User Guide.",
            options: [
                {
                    name: "--workload-name",
                    description: "The name of the workload. The name must be unique within an account within a Region. Spaces and capitalization are ignored when checking for uniqueness.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Disassociate a lens from a workload.  The AWS Well-Architected Framework lens (wellarchitected) cannot be removed from a workload.",
            options: [
                {
                    name: "--workload-id",
                    description: "The ID assigned to the workload. This ID is unique within an AWS Region.",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--lens-alias",
                    description: "The alias of the lens, for example, serverless. Each lens is identified by its LensSummary$LensAlias.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
