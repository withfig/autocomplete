    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                {
                    name: "--names",
                    description: "The names or ARNs of the build projects. To get information about a project shared with your AWS account, its ARN must be specified. You cannot specify a shared project using its name.",
                    args: {
                        name: "list",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "A list of tag key and value pairs associated with this build project. These tags are available for use by AWS services that support AWS CodeBuild build project tags.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "A list of tag key and value pairs associated with this report group.  These tags are available for use by AWS services that support AWS CodeBuild report group tags.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--project-name",
                    description: "The name of the AWS CodeBuild build project that the cache is reset for.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            description: "Gets a list ARNs for the report groups in the current AWS account.",
            options: [
                {
                    name: "--sort-order",
        ...
        {
            name: "list-reports",
            description: "Returns a list of ARNs for the reports in the current AWS account.",
            options: [
                {
                    name: "--sort-order",
        ...
        },
        {
            ...
            description: "Gets a list of projects that are shared with other AWS accounts or users.",
            options: [
                {
                    name: "--sort-by",
                    description: "The criterion to be used to list build projects shared with the current AWS account or user. Valid values include:     ARN: List based on the ARN.     MODIFIED_TIME: List based on when information about the shared project was last changed.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Gets a list of report groups that are shared with other AWS accounts or users.",
            options: [
                {
                    name: "--sort-order",
                ...
                {
                    name: "--sort-by",
                    description: "The criterion to be used to list report groups shared with the current AWS account or user. Valid values include:     ARN: List based on the ARN.     MODIFIED_TIME: List based on when information about the shared report group was last changed.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                {
                    name: "--policy",
                    description: "A JSON-formatted resource policy. For more information, see Sharing a Project and Sharing a Report Group in the AWS CodeBuild User Guide.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--image-pull-credentials-type-override",
                    description: "The type of credentials AWS CodeBuild uses to pull images in your batch build. There are two valid values:   CODEBUILD  Specifies that AWS CodeBuild uses its own credentials. This requires that you modify your ECR repository policy to trust AWS CodeBuild's service principal.  SERVICE_ROLE  Specifies that AWS CodeBuild uses your build project's service role.    When using a cross-account or private registry image, you must use SERVICE_ROLE credentials. When using an AWS CodeBuild curated image, you must use CODEBUILD credentials.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--service-role",
                    description: "The replacement ARN of the AWS Identity and Access Management (IAM) role that enables AWS CodeBuild to interact with dependent AWS services on behalf of the AWS account.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
                ...
                {
                    name: "--timeout-in-minutes",
                    description: "The replacement value in minutes, from 5 to 480 (8 hours), for AWS CodeBuild to wait before timing out any related build that did not get marked as completed.",
                    args: {
                        name: "integer",
                    },
                    isOptional: true,
                ...
                {
                    name: "--tags",
                    description: "An updated list of tag key and value pairs associated with this build project. These tags are available for use by AWS services that support AWS CodeBuild build project tags.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
                ...
                {
                    name: "--logs-config",
                    description: "Information about logs for the build project. A project can create logs in Amazon CloudWatch Logs, logs in an S3 bucket, or both.",
                    args: {
                        name: "structure",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "An updated list of tag key and value pairs associated with this report group.  These tags are available for use by AWS services that support AWS CodeBuild report group tags.",
                    args: {
                        name: "list",
                    },
                    isOptional: true,
        ...
        {
            name: "update-webhook",
            description: "Updates the webhook associated with an AWS CodeBuild build project.    If you use Bitbucket for your repository, rotateSecret is ignored.",
            options: [
                {
                    name: "--project-name",
                    description: "The name of the AWS CodeBuild project.",
