    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "A list of key-value pairs that contain metadata for the resource. For more information, see Tag your resources in the AWS IoT Greengrass V2 Developer Guide.",
                    args: {
                        name: "map",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The name of the deployment. You can create deployments without names. If you create a deployment without a name, the AWS IoT Greengrass V2 console shows the deployment name as &lt;targetType&gt;:&lt;targetName&gt;, where targetType and targetName are the type and name of the deployment target.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
        ...
        },
        {
            ...
            description: "Deletes a version of a component from AWS IoT Greengrass.  This operation deletes the component's recipe and artifacts. As a result, deployments that refer to this component version will fail. If you have deployments that use this component version, you can remove the component from the deployment or update the deployment to use a valid version.",
            options: [
                {
                    name: "--arn",
        ...
        },
        {
            ...
            description: "Deletes a AWS IoT Greengrass core device, which is an AWS IoT thing. This operation removes the core device from the list of core devices. This operation doesn't delete the AWS IoT thing. For more information about how to delete the AWS IoT thing, see DeleteThing in the AWS IoT API Reference.",
            options: [
                {
        ...
        },
        {
            ...
            options: [
                {
                    name: "--arn",
                    description: "The ARN of the component version. Specify the ARN of a public component version.",
                    args: {
                        name: "string",
                    },
                    isOptional: false,
            ...
            options: [
                {
                    ...
                    description: "The ARN of the AWS IoT thing group by which to filter. If you specify this parameter, the list includes only core devices that are members of this thing group.",
                    args: {
                        name: "string",
                    },
                    isOptional: true,
