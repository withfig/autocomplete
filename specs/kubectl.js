...
var sharedArgs = {
  ...
  listDeployments: {
    ...
    generators: {
      script: function () {
        return scripts.typeWithoutName("deployments");
      },
      postProcess: sharedPostProcess,
    },
  },
  ...
  listNodes: {
    ...
    generators: {
      script: function () {
        return scripts.typeWithoutName("nodes");
      },
      postProcess: sharedPostProcess,
    },
  },
  listClusterRoles: {
    ...
    generators: {
      script: function () {
        return scripts.typeWithoutName("clusterroles");
      },
      postProcess: sharedPostProcess,
    },
  },
  listContainersFromPod: {
    ...
    generators: {
      ...
      postProcess: function (out) {
        ...
        return JSON.parse(out).spec.containers.map(function (item) {
          return {
            name: item.name,
...
var sharedOptsArray = Object.values(sharedOpts);
var completionSpec = {
  name: "kubectl",
  description: "",
  subcommands: [
    ...
    },
    {
      ...
      subcommands: [
        ...
        },
        {
          ...
          args: __assign(__assign({}, sharedArgs.listKubeConfContexts), {
            isOptional: true,
          }),
          options: [
            sharedOpts.output,
          ...
          options: [
            ...
            sharedOpts.template,
            {
              ...
              args: {
                ...
                generators: {
                  script: function () {
                    return scripts.typeWithoutName("cronjob");
                  },
                  postProcess: function (out) {
                    return sharedPostProcess(out).map(function (item) {
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                ...
                generators: {
                  script: function () {
                    return scripts.typeWithoutName("roles");
                  },
                  postProcess: sharedPostProcess,
                },
              },
