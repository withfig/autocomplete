    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          name: ["--local"],
          description:
            "Use only gems already downloaded or cached",
        },
        {
          name: ["--ruby"],
          description:
    ...
    // Utility Commands
    {
      ...
      options: [
        ...
        },
        {
          name: ["--group", "-g"],
          description:
            "Specify the group(s) for the added gem",
        },
        {
          name: ["--source", "-s"],
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          name: ["--no-coc"],
          description:
            "Do not create a CODE_OF_CONDUCT.md",
        },
        {
          name: [
            "--ext",
